...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $discountcourse = Course::where('type', '1')->where('status', 1)->with('user')->latest()->take(10)->get();
        ...
        $shortcorses = Course::where('subcategory_id', '14')->where('status', 1)->with('user')->latest()->take(10)->get();
        $longcourses = Course::where('subcategory_id', '15')->where('status', 1)->with('user')->latest()->take(10)->get();
        ...
        $cors = Course::where('status', '1')->with('user')->latest()->take(10)->get();/* ->map(function ($c) use ($usercountry) {
        ...
        return view('home', compact('category', 'workshops', 'shortcorses','longcourses','sliders', 'facts', 'categories', 'cors', 'bundles', 'meetings', 'bigblue', 'testi', 'trusted', 'recent_course_id', 'blogs', 'subscriptionBundles', 'batches', 'recent_course', 'total_count', 'advs', 'allgooglemeet', 'jitsimeeting', 'googleclassrooms', 'usercountry', 'instructors', 'factsetting', 'videosetting', 'discountcourse', 'bestselling', 'menus', 'pages', 'instruct', 'institute', 'get_enable'));
    }
