...
class ViewmoreController extends Controller
{
    ...
    public function workshopsdata(Request $request)
    {

        $shops = Workshop::where('status', '1')->latest()->take(10)->get()/* ->map(function($c) use($usercountry) {
        ...
        return view('front.viewmore.workshops', compact('shops'));
    }
    ...
    public function shortcourse(Request $request)
    {
        ...
        $shops = Course::where('subcategory_id', '14')->latest()->get()
        
        /* ->map(function($c) use($usercountry) {
                               if($c->country != ''){
                if(!in_array($usercountry,$c->country)){
                    return $c;
                }
        ...
        return view('front.viewmore.shortcourse', compact('shops'));
    }
    ...
    public function longcourse(Request $request)
    {
        ...
        $shops = Course::where('subcategory_id', '15')->latest()->get()/* ->map(function($c) use($usercountry) {
        ...
        return view('front.viewmore.longcourse', compact('shops'));
    }
