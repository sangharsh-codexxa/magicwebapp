...
<div class="col-md-4 col-lg-4">
  <div class="widgetbar">
    <a href="<?php echo e(route('batch.index')); ?>"  class="btn btn-primary-rgba"><i
    ...
    <div class="col-lg-12">
      <div class="card m-b-30">
        <div class="card-header">
          <h5 class="card-box"><?php echo e(__('Add')); ?> <?php echo e(__('Batch')); ?></h5>
        </div>
        <div class="card-body">
          <form action="<?php echo e(url('batch/')); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                  <label for="exampleInputTit1e"><?php echo e(__('Title')); ?>: <sup class="text-danger">*</sup></label>
                ...
                <div class="form-group col-md-6">
                  <label><?php echo e(__('Add')); ?> <?php echo e(__('Course')); ?>: <span
                ...
                <div class="form-group col-md-6">
                  <label><?php echo e(__('Add')); ?> <?php echo e(__('Users')); ?>: <span
                      class="text-danger">*</span></label>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <label for="exampleInputTit1e"><?php echo e(__('Detail')); ?>: <sup
                        ...
                        <textarea  name="detail" rows="5"  class="form-control" placeholder="<?php echo e(__('Enter')); ?> <?php echo e(__('Detail')); ?>" ></textarea>
                  </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views\admin\batch\create.blade.php ENDPATH**/ ?>