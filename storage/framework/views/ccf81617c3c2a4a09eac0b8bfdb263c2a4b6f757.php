    ...
    <div class="col-lg-12">
      <div class="card m-b-30">
        <div class="card-header">
          <h5 class="box-title"><?php echo e(__('Edit')); ?> <?php echo e(__('Admin')); ?></h5>
        </div>
        <div class="card-body ml-2">
          <form action="<?php echo e(route('alladmin.update',$user->id)); ?>" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="role">
                    <option <?php echo e($user->role == 'admin' ? 'selected' : ''); ?> value="admin"><?php echo e(__('Admin')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views\admin\alladmin\edit.blade.php ENDPATH**/ ?>