...
<?php $__env->slot('heading'); ?>
   <?php echo e(__('Create a new meeting')); ?>
...
<div class="col-md-4 col-lg-4">
  <div class="widgetbar">
    <a href="<?php echo e(url('googlemeet/dashboard')); ?>" class="btn btn-primary-rgba"><i class="feather icon-arrow-left mr-2"></i><?php echo e(__("Back")); ?></a>
    ...
    <div class="col-lg-12">
      <div class="card m-b-30">
        ...
        <div class="card-body">
			...
			<form autocomplete="off" action="<?php echo e(route('googlemeet.store')); ?>" method="POST" enctype="multipart/form-data">
				<?php echo csrf_field(); ?>
          ...
          <div class="row">
            ...
            <div class="form-group col-md-12">
				...
				<input type="text" name="topic" placeholder="<?php echo e(__('Example: My Meeting')); ?>" class="form-control" required>
              </div>
            ...
            <div class="form-group col-md-6"  id="sec3_three">
				<label>
					<?php echo e(__('Meeting')); ?> <?php echo e(__('Agenda')); ?>:<sup class="redstar">*</sup>
				</label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views\googlemeet\create.blade.php ENDPATH**/ ?>