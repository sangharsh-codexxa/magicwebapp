...
<?php $__env->startSection('title', 'Create new Zoom meeting'); ?>
<?php $__env->startSection('maincontent'); ?>
 

<?php $__env->startComponent('components.breadcumb',['thirdactive' => 'active']); ?>
<?php $__env->slot('heading'); ?>
   <?php echo e(__('Create new Zoom meeting')); ?>
...
<div class="col-md-4 col-lg-4">
  <div class="widgetbar">
      <a href="<?php echo e(route('zoom.index')); ?>" class="btn btn-primary-rgba"><i class="feather icon-arrow-left mr-2"></i><?php echo e(__("Back")); ?></a>
    ...
    <div class="col-lg-12">
      <div class="card m-b-30">
        <div class="card-header">
          <h5 class="card-title"><?php echo e(__('Create new Zoom meeting')); ?></h5>
        </div>
        <div class="card-body">
          
          <form autocomplete="off" action="<?php echo e(route('zoom.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
          ...
          <div class="row">
            ...
            <div class="form-group col-md-12">
              <label>
                <?php echo e(__('adminstaticword.MeetingTopic')); ?>:<sup class="redstar">*</sup>
              </label>
            ...
            <div class="form-group col-md-6" id="sec4_four">
              <label>
                <?php echo e(__('adminstaticword.StartTime')); ?> :<sup class="redstar">*</sup>
              </label>
            ...
            <div class="form-group col-md-6" id="sec3_three">
              <label>
                <?php echo e(__('adminstaticword.Duration')); ?>:<sup class="redstar">*</sup>
              </label>
             ...
             <div class="form-group  col-md-6">
              <label>
                <?php echo e(__('adminstaticword.Password')); ?>: (Optional)
              </label>
                <div class="input-group mb-3">
            ...
            <div class="form-group col-md-6">
              <label>
                <?php echo e(__('adminstaticword.Meeting')); ?> <?php echo e(__('adminstaticword.Agenda')); ?>:<sup class="redstar">*</sup>
              </label>
            ...
            <div class="form-group col-md-6">
              <label><?php echo e(__('adminstaticword.Timezone')); ?>:</label>
            ...
            <div class="form-group col-md-12">
              <div class="panel-body">
                <h5 class="panel-title"><?php echo e(__('adminstaticword.Meeting')); ?> <?php echo e(__('adminstaticword.Setting')); ?> :</h5>
                <hr>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views\zoom\create.blade.php ENDPATH**/ ?>