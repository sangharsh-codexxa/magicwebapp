...
<?php $__env->startSection('title', 'Database Backup - Admin'); ?>
<?php $__env->startSection('maincontent'); ?>
<?php $__env->startComponent('components.breadcumb',['fourthactive' => 'active']); ?>
<?php $__env->slot('heading'); ?>
<?php echo e(__('Database Backup')); ?>
		...
		<div class="col-lg-12">
			<div class="card m-b-30">
				<div class="card-header">
					<h5 class="box-title"><?php echo e(__('Backup Manager')); ?></h5>
				</div>
						...
						<div class="col-md-12">
							...
							<div class="input-group">
								<input name="DUMP_BINARY_PATH" required type="text" class="form-control"
									placeholder="MY SQL DUMP PATH" value="<?php echo e($dump); ?>" aria-describedby="basic-addon2">
					...
					<div class="card-body">
						...
						<div class="col-md-6">
							...
							<a <?php if(env('DUMP_BINARY_PATH') != '' ): ?> href="<?php echo e(url('database/genrate?type=onlydb')); ?>"
								<?php else: ?> href="#" disabled <?php endif; ?> class="btn btn-md btn-primary-rgba">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views\admin\database\backup.blade.php ENDPATH**/ ?>