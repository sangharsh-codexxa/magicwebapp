...
<?php $__env->slot('heading'); ?>
   <?php echo e(__('Reported Question')); ?>
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="box-title"><?php echo e(__('Report')); ?> <?php echo e(__('Question')); ?></h5>
                </div>
                <div class="card-body">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views\admin\question_report\index.blade.php ENDPATH**/ ?>