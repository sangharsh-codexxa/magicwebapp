                ...
                <div class="col-lg-6 col-md-6">
                    ...
                    Magic WelBeing
                        ...
                        <div class="signup-block">
                            ...
                            <div class="sign-up text-center"><?php echo e(__('Donothaveanaccount')); ?>?<a href="<?php echo e(route('register')); ?>" title="sign-up"> <?php echo e(__('Signup')); ?></a>
                            </div>
                            <hr>
...
<?php echo $__env->make('theme.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\eclass\eclass\resources\views/auth/login.blade.php ENDPATH**/ ?>