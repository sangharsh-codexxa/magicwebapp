						...
						<tr>
							...
							<td>
								...
								<div class="unsubscribe-btn">
									<form id="unsubscribeForm" action="<?php echo e(route('stripe.cancelsubscription')); ?>" method="POST" accept-charset="UTF-8">
										<?php echo e(csrf_field()); ?>

										<input type="hidden" value="<?php echo e($order->id); ?>" name="order_id">
										<a onclick="document.getElementById('unsubscribeForm').submit()" class="btn btn-secondary"><?php echo e(__('UnSubscribe')); ?></a>
									</form>
								</div>
								<?php endif; ?>
						...
						<tr>
							...
							<td>
								<div class="purchase-text"><b>
										...
										<?php echo e($order->total_amount); ?></b>
									</div>
...
<?php echo $__env->make('theme.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views\front\purchase_history\purchase.blade.php ENDPATH**/ ?>