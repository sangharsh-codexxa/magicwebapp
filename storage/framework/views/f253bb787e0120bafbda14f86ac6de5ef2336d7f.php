...
<?php $__env->slot('heading'); ?>
   <?php echo e(__('Add FAQ Instructor')); ?>
    ...
    <div class="col-lg-12">
        ...
        <div class="card m-b-30">
                ...
                <div class="card-header">
                    <h5 class="card-box"> <?php echo e(__('Add FAQ Instructor')); ?></h5>
                </div> 
           ...
           <!-- form start -->
           <form action="<?php echo e(url('faqinstructor/')); ?>" class="form" method="POST" novalidate enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <!-- row start -->
                        <div class="row">
                            <div class="col-md-12">
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea id="detail" rows="3" name="details" class="<?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="<?php echo e(__('Enter')); ?> <?php echo e(__('Detail')); ?>" required=""><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views\admin\faq_instructor\create.blade.php ENDPATH**/ ?>