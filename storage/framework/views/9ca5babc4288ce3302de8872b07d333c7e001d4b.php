    ...
    <div class="lazy item home-slider-img">
        ...
        <div id="home" class="home-main-block"
            ...
            <div class="container">
                <div class="row">
                    <div
                        class="col-lg-12 <?php echo e($slider['left'] == 1 ? 'col-md-offset-6 col-sm-offset-6 col-sm-6 col-md-6' : ''); ?>">
                        <div class="home-dtl">
                            ...
                            <form method="GET" id="searchform" action="<?php echo e(route('search')); ?>">
                                <div class="search">
                                    ...
                                    <input type="text" name="searchTerm" class="searchTerm"
                                        placeholder="<?php echo e(__('What do you want to learn?')); ?>">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-7">
                <h4 class="student-heading"><?php echo e(__('Top Courses')); ?></h4>
            </div>
            <div class="col-lg-6 col-md-6 col-5">
                <div class="view-button txt-rgt">
                    <a href="<?php echo e(url('featuredcourse/view')); ?>" class="btn btn-secondary" title="View More"><?php echo e(__('View More')); ?><i data-feather="chevron-right"></i>
                    </a>
                </div>
            </div>
        </div>
        <div id="student-view-slider" class="student-view-slider-main-block owl-carousel">
            ...
            <div class="item student-view-block student-view-block-1">
                <div class="genre-slide-image <?php if($gsetting['course_hover'] == 0): ?> protip <?php endif; ?>"
                    ...
                    <div class="view-block">
                        ...
                        <div class="view-dtl">
                            ...
                            <div class="user-name">
                                <h6><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>By <span><a href="<?php echo e(route('all/profile',$c->user->id)); ?>"> <?php echo e(optional($c->user)['fname']); ?></a></span></h6>
                            </div>
                            <div class="rating">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                      	<div class="protip-btn">
                                            <a href="https://magic.exportica.in/login" class="btn btn-primary" title="Enroll Now"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-shopping-cart"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg>Enroll Now</a>
                                        </div>
                        ...
                        <div class="icons-wrap">
                            <div class="icons-item">
                                <div class="item-box">
                                    ...
                                    <p>Magic’s courses and workshop roster and designs
            ...
            <div class="challenges masonry flex-row item-col-2">
                <div class="item-col full-size">
                    <div class="challenge-item">
                        <div class="bg-img" data-bg="images/logo/608x598_img1.jpg"
                            style="background-image: url(&quot;images/logo/608x598_img1.jpg&quot;);"></div>
                        <a href="#" class="link"></a>
                         <div class="inner">
                        <h3 class="item-title"><a href="#">Being A Healer</a></h3>
                          <p style="color:#fff" class="limit">Leran and perfect the tools and modalities needed to become an
        ...
        <div class="container wide3">
            <div class="content-element6">
                <div class="align-center" style="text-align:center;">
                    ...
                    <p class="text-size-medium">If you are just beginning your journey and are looking for a place to begin, you are at the eight place!.</p>
                    <p class="text-size-medium" style="font-style:italic">Choose any of these transformational courses, priced incredibly low to keep them accessible, to begin your empowerment journey.</p>
                </div>
            </div>
            <div class="challenges masonry flex-row item-col-2">
                <div class="item-col full-size">
                    <div class="challenge-item">
                        ...
                        <a href="#" class="link"></a>
                         <div class="inner">
                            <h3 class="item-title"><a href="#">Self-Love Healing</a></h3>
                              <p style="color:#fff " class="limit">Based on the 21-day program by Louise Hay. We hand-hold you with exercises and affirmations.</p>
                               <p style="color: #fff;    background-color: #f8ba00;    margin-top: 20px;    font-weight: 500;    padding: 3px;">21 days</p>
                            <a href="#" class="item-country">ONLINE | WHATSAPP</a>
                           
                        	<h3 class="item-title"><a href="#">&#x20B9 2,100</a></h3>
                ...
                <div class="item-col full-size">
                    <div class="challenge-item">
                        ...
                        <a href="#" class="link"></a>
                        <div class="inner">
                        <h3 class="item-title"><a href="#">Attract Good Luck</a></h3>
                            <p style="color:#fff" class="limit">A simple-to-follow 11-day program packed with Good Luck its and exercises to</p>
                          <p style="color: #fff;    background-color: #f8ba00;    margin-top: 20px;    font-weight: 500;    padding: 3px;">11 days</p>
                        <a href="#" class="item-country">ONLINE | WHATSAPP</a>
                        <h3 class="item-title"><a href="#">&#x20B9 6,000</a></h3>
                          <div class="butns">
                            <a href="#">Enroll Now</a>
                        </div>
                          <div class="more_btn">
                ...
                <div class="item-col full-size">
                    <div class="challenge-item">
                        ...
                        <a href="#" class="link"></a>
                        <div class="inner">
                        <h3 class="item-title"><a href="#">Angel Invocation</a></h3>
                            <p style="color:#fff" class="limit">Connect to the beautiful angelic energy to help you move forward in life and find a support system.</p>
                          <p style="color: #fff;    background-color: #f8ba00;    margin-top: 20px;    font-weight: 500;    padding: 3px;">7 days</p>
                        <a href="#" class="item-country">ONLINE | WHATSAPP</a>
                        <h3 class="item-title"><a href="#">&#x20B9 6,000</a></h3>
                        <div class="butns">
                            <a href="#">Enroll Now</a>
        ...
        <div class="container wide3">
            <div class="content-element6">
                <div class="align-center" style="text-align:center;">
                    ...
                    <p class="text-size-medium">Extremely beneficial for healers and professionals working in well-being. Keep growing your skills and your knowledge with these advanced courses.</p>
                    <p class="text-size-medium" style="font-style:italic">Take your own inner practice up few levels to keep up with the demands on your energy levels.</p>
                </div>
            </div>
            <div class="challenges masonry flex-row item-col-2">
                <div class="item-col full-size">
                        ...
                        <a href="#" class="link"></a>
                         <div class="inner">
                            <h3 class="item-title"><a href="#">Advanced Chakra therapy</a></h3>
                              <p class="limit" style="color:#fff">Go deep into each chakra and learn to leverage its secrets fully.</p>
                               <p style="color: #fff;    background-color: #f8ba00;    margin-top: 20px;    font-weight: 500;    padding: 3px;">12 months with 8 sessions</p>
                ...
                <div class="item-col full-size">
                    <div class="challenge-item">
                        ...
                        <h3 class="item-title"><a href="#">Goddness Tarot Reading</a></h3>
                            <p class="limit" style="color:#fff">Bring the Goddess into your Tarot Reading to become a Master Manifestor.</p>
                          <p style="color: #fff;    background-color: #f8ba00;    margin-top: 20px;    font-weight: 500;    padding: 3px;">12 months with 12 sessions</p>
                        <a href="#" class="item-country">IN-PERSON + ONLINE | WHATSAPP</a>
                ...
                <div class="item-col full-size">
                    <div class="challenge-item">
                        ...
                        <h3 class="item-title"><a href="#">Atma<br>Siddi</a></h3>
                            <p class="limit" style="color:#fff">Only for dedicated professionals looking to leap into the next level of transformation and evolution.</p>
                          <p style="color: #fff;    background-color: #f8ba00;    margin-top: 20px;    font-weight: 500;    padding: 3px;">3 years with sessions as needed</p>
                        <a href="#" class="item-country">IN-PERSON + ONLINE | WHATSAPP</a>
...
<section id="student" class="student-main-block top-40">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-5">
                <div class="view-button txt-rgt">
                    <a href="<?php echo e(url('topdiscounted/view')); ?>" class="btn btn-secondary" title="View More">View More<i data-feather="chevron-right"></i>
                    </a>
                </div>
            </div>
        </div>
             ...
             <div class="item">
                <div class="instructor-home-block text-center">
                    <div class="instructor-home-block-one">
                        ...
                        <?php else: ?>
                        <a href="#" title=""><img src="<?php echo e(Avatar::create($inst->user->fname)->toBase64()); ?>" alt="course"
                            class="img-fluid"></a>
                        <?php endif; ?>
    ...
    <div class="container-fluid p-0">
        <div class="get-started-block">
            <div class="get-started-bg-image">
                ...
                <?php else: ?>
                <img src="<?php echo e(Avatar::create($get_enable->heading)->toBase64()); ?>" alt="course"
                    class="img-fluid">
                <?php endif; ?>                
                <div class="overlay-bg"></div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('theme.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\magic\resources\views/home.blade.php ENDPATH**/ ?>