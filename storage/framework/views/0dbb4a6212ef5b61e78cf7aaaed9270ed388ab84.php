              ...
              <div class="modal-body">
                <form enctype="multipart/form-data" id="demo-form2" method="post"
                  ...
                  <div class="row">
                    ...
                    <!--video-->
                    <div class="col-md-12 btm-20" id="videotype">
                      ...
                      <input type="radio" name="checkVideo" id="ch10"
                        value="liveurl">&nbsp;<?php echo e(__('LiveClass')); ?>
...
<?php $__env->stopSection(); ?><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views/admin/course/courseclass/index.blade.php ENDPATH**/ ?>