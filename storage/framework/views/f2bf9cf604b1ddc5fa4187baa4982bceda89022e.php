<div class="row">
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                        <a class="dropdown-item" href="<?php echo e(route('adminstatic.lang', $language->local)); ?>"><i class="feather icon-edit mr-2"></i><?php echo e(__('Edit')); ?></a>
                                    </div>
                                </div>
    ...
    </div><!-- row end --><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views\admin\language\adminstatic\index.blade.php ENDPATH**/ ?>