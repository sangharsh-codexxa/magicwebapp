...
<div class="col-md-4 col-lg-4">
  <div class="widgetbar">
      ...
      <a href="<?php echo e(route('jitsi.create')); ?>" class="btn btn-primary-rgba"><i class="feather icon-plus mr-2"></i><?php echo e(__("Add Jitsmeeting")); ?></a>
	  <?php endif; ?>
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="box-title"><?php echo e(__('Jitsmeeting')); ?></h5>
                </div>
                <div class="card-body">
										  ...
										  <td>
											<div class="dropdown">
												...
												<div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton3">
													<a title="Start Meeting" target="_blank" href="<?php echo e(url('meetup-conferencing/'.$meeting->meeting_id)); ?>" class="dropdown-item" ><i class="feather icon-send mr-2"></i><?php echo e(__("Start Meetings")); ?></a>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views\admin\jitsimeeting\dashboard.blade.php ENDPATH**/ ?>