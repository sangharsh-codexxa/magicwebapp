                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        ...
                                        <p class="font-12 mb-0"><?php echo e(__('Jitsi Meetings')); ?></p>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        ...
                                        <p class="font-12 mb-0"><?php echo e(__('Google Meetings')); ?></p>
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/magic.bizz-manager.com/public_html/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>