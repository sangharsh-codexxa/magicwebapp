...
<div class="col-md-4 col-lg-4">
    <div class="widgetbar">
      ...
      <button type="button" class="float-right btn btn-danger-rgba mr-2 " data-toggle="modal" data-target="#bulk_delete"><i
        ...
        <a href="<?php echo e(route('private-course.create')); ?>"  class="float-right btn btn-primary-rgba mr-2"><i class="feather icon-plus mr-2"></i><?php echo e(__('Add Private Course')); ?></a>
    <?php endif; ?>
    </div>                        
</div>
      ...
      <div class="col-lg-12">
          <div class="card m-b-30">
              <div class="card-header">
                  <h5 class="card-box"><?php echo e(__('All Courses')); ?></h5>
              </div>
              <div class="card-body">
                                      ...
                                      <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('private-course.edit')): ?>
                                            <a class="dropdown-item" href="<?php echo e(route('private-course.show',$course->id)); ?>}"><i class="feather icon-edit mr-2"></i><?php echo e(__('Edit')); ?></a>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('private-course.delete')): ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views\admin\private_course\index.blade.php ENDPATH**/ ?>