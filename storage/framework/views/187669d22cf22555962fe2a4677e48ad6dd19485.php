...
<section id="home-background-slider" class="background-slider-block owl-carousel">
    <div class="lazy item home-slider-img">
        ...
        <div id="home" class="home-main-block" style="background-image: url('<?php echo e(asset('images/slider/'.$slider['image'])); ?>')">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 <?php echo e($slider['left'] == 1 ? 'col-md-offset-6 col-sm-offset-6 col-sm-6 col-md-6' : ''); ?>">
                        <div class="home-dtl">
                            <div class="home-heading"><?php echo e($slider['heading']); ?></div>
                            <p class=" subhead btm-10"><?php echo e($slider['sub_heading']); ?></p>
                        ...
                        <div class="home-search">
                            <form method="GET" id="searchform" action="<?php echo e(route('search')); ?>">
                                <div class="search">
                                    ...
                                    <input type="text" name="searchTerm" class="searchTerm" placeholder="<?php echo e(__('What do you want to learn?')); ?>">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-7">
                <h4 class="student-heading"><?php echo e(__('Courses')); ?></h4>
            </div>
            <div class="col-lg-6 col-md-6 col-5">
                <div class="view-button txt-rgt">
                    <a href="<?php echo e(url('featuredcourse/view')); ?>" class="btn btn-secondary" title="View More"><?php echo e(__('View
        ...
        <div id="student-view-slider" class="student-view-slider-main-block owl-carousel">
            ...
            <div class="item student-view-block student-view-block-1">
                <div class="genre-slide-image <?php if($gsetting['course_hover'] == 0): ?>  <?php endif; ?>" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block<?php echo e($c->id); ?>">
                    <div class="view-block">
                        ...
                        <div class="view-dtl">
                            <div class="view-heading"><a href="<?php echo e(route('user.course.show',['id' => $c->id, 'slug' => $c->slug ])); ?>"><?php echo e(str_limit($c->title, $limit = 30, $end = '...')); ?></a>
                            </div>
                            <div class="user-name">
                                <h6><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user">
                                    ...
                                    </svg>By <span><a href="<?php echo e(route('all/profile',$c->user->id)); ?>"> <?php echo e(optional($c->user)['fname']); ?></a></span></h6>
                            </div>
                            <div class="rating">
                            ...
                            <div class="view-footer">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                        ...
                                        <a class="btn btn-primary" style="padding: 0.375rem 0.75rem;" href="<?php echo e(route('user.course.show',['id' => $c->id, 'slug' => $c->slug ])); ?>">
                                            View Details
                                        </a>
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                        ...
                                        <div class="rate text-right">
                                            <ul>
                                                ...
                                                <li><a><b><?php echo e(activeCurrency()->getData()->position == 'l' ?
                                                            activeCurrency()->getData()->symbol :''); ?><?php echo e(price_format(
                                                            ...
                                                            = false))); ?><?php echo e(activeCurrency()->getData()->position == 'r'
                                                            ? activeCurrency()->getData()->symbol :''); ?></b></a>
                                                </li>

                                                <li><a><b><strike><?php echo e(activeCurrency()->getData()->position == 'l' ?
                                                                activeCurrency()->getData()->symbol :''); ?><?php echo e(price_format( currency($c['price'], $from =
                                                                $currency->code, $to = Session::has('changed_currency')
                                                                ? Session::get('changed_currency') : $currency->code,
                                                                $format = false) )); ?><?php echo e(activeCurrency()->getData()->position == 'r' ?
                                                                activeCurrency()->getData()->symbol :''); ?></strike></b></a>
                                                </li>
                ...
                <!-- <div id="prime-next-item-description-block<?php echo e($c->id); ?>" class="prime-description-block">
                    <div class="prime-description-under-block">
                        <div class="prime-description-under-block">
                            <h5 class="description-heading"><?php echo e($c['title']); ?>    sr testing pro tip</h5>
                            <div class="main-des">
                            ...
                            <div>
                                ...
                                <div class="product-learn-dtl">
                                    <ul>
                                        <li><i data-feather="check-circle"></i><?php echo e(str_limit($wl['detail'], $limit = 120,
                                            $end = '...')); ?>
                            ...
                            <div class="des-btn-block">
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        <div class="protip-btn">
                                            <form id="demo-form2" method="post" action="<?php echo e(route('remove.item.cart',$cart->id)); ?>">
                                                ...
                                                <div class="box-footer">
                                                    <button type="submit" class="btn btn-primary"><?php echo e(__('Remove From
                                                        Cart')); ?></button>
                                                </div>
                                            </form>
                                        </div>
                                        ...
                                        <?php if($enroll == NULL): ?>
                                        <div class="protip-btn">
                                            <a href="<?php echo e(url('enroll/show',$c->id)); ?>" class="btn btn-primary" title="Enroll Now"><i data-feather="shopping-cart"></i><?php echo e(__('Enroll
                                                Now')); ?></a>
                                        </div>
                                        <?php else: ?>
                                        <div class="protip-btn">
...
<div class="page-section riskwala" id="transforming">
    <div class="container wide3">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-7">
                <h4 class="student-heading"><?php echo e(__('Workshop')); ?></h4>
            </div>
            <div class="col-lg-6 col-md-6 col-5">
                <div class="view-button txt-rgt">
                    <a href="<?php echo e(url('workshopsdata/view')); ?>" class="btn btn-secondary" title="View More"><?php echo e(__('View
                        More')); ?><i data-feather="chevron-right"></i>
                    </a>
                </div>
            </div>
        ...
        <div class="challenges masonry flex-row item-col-2">
            ...
            <div class="item-col full-size">
                <div class="ribbon ribbon-top-left"><span><?php echo e($days); ?> days</span></div>
                <div class="challenge-item">
                    <div class="bg-img" data-bg="<?php echo e(asset('images/workshop/'.$workshop['image'])); ?>" style="background-image: url(&quot;<?php echo e(asset('images/workshop/'.$workshop['image'])); ?>&quot;);background-position: center;">
                    </div>
                    <a href="#" class="link"></a>
                    <div class="inner">
                        <h3 class="item-title"><a href="#"><?php echo e($workshop->title); ?></a></h3>

                        <p style="color:#fff " class="limit"><?php echo e($workshop->description); ?></p>

                        <a href="#" class="item-country">ONLINE | WHATSAPP</a>

                        <h3 class="item-title"><a href="#"><?php echo e(activeCurrency()->getData()->position == 'l'
                                                            ? activeCurrency()->getData()->symbol : ''); ?> <?php echo e(price_format($workshop->fee)); ?></a></h3>

                        <div class="butns">
                            <a href="<?php echo e(url('workshop') . '/' . $workshop['id']); ?>/details">Book Now</a>
                        </div>
...
<!-- Student start -->
<?php if(Auth::check()): ?>
<?php if($hsetting->recentcourse_enable == 1 && isset($recent_course_id) && isset($recent_course) &&
                ...
                <div class="genre-slide-image">
                    <div class="view-block">
                        ...
                        <div class="view-user-img">
                            ...
                            <a href="<?php echo e(route('all/profile',$recent_course->user->id)); ?>" title=""><img src="<?php echo e(asset('images/user_img/'.$recent_course->user['user_img'])); ?>" class="img-fluid user-img-one" alt=""></a>
                            <?php else: ?>
                            <a href="<?php echo e(route('all/profile',$recent_course->user->id)); ?>" title=""><img src="<?php echo e(asset('images/default/user.png')); ?>" class="img-fluid user-img-one" alt=""></a>
                            <?php endif; ?>
                        </div>
                        <div class="view-dtl">
                            <div class="view-heading"><a href="<?php echo e(route('user.course.show',['id' => $recent_course->id, 'slug' => $recent_course->slug ])); ?>"><?php echo e(str_limit($recent_course->title, $limit = 30, $end = '...')); ?></a>
                            </div>
                            <div class="user-name">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                        ...
                                        <div class="rate text-right">
                                            <ul>
                                                ...
                                                <li><a><b>
                                                            <?php echo e(currency($recent_course->discount_price, $from =
                                                            $currency->code, $to = Session::has('changed_currency') ?
                                                            Session::get('changed_currency') : $currency->code, $format
                                                            = true)); ?>
                                                ...
                                                <li><a><b><strike><?php echo e(currency($recent_course->price, $from =
                                                                $currency->code, $to = Session::has('changed_currency')
                                                                ? Session::get('changed_currency') : $currency->code,
                                                ...
                                                <?php else: ?>
                                                <li><a><b>
                                                            <?php echo e(currency($recent_course->price, $from = $currency->code,
                            ...
                            <div class="img-wishlist">
                                <div class="protip-wishlist">
                                    <ul>
                                        ...
                                        <?php if($wish == NULL): ?>
                                        <li class="protip-wish-btn">
                                            <form id="demo-form2" method="post" action="<?php echo e(url('show/wishlist', $recent_course->id)); ?>" data-parsley-validate class="form-horizontal form-label-left">
                                                <?php echo e(csrf_field()); ?>
                                        ...
                                        <?php else: ?>
                                        <li class="protip-wish-btn-two">
                                            <form id="demo-form2" method="post" action="<?php echo e(url('remove/wishlist', $recent_course->id)); ?>" data-parsley-validate class="form-horizontal form-label-left">
                                                <?php echo e(csrf_field()); ?>
...
<section id="student" style="display:none;" class="student-main-block top-40">
    <div class="container-xl">
        ...
        <h4 class="student-heading" style="display:none;"><?php echo e(__('My Purchased Courses')); ?></h4>
                ...
                <div class="genre-slide-image">
                    <div class="view-block">
                        ...
                        <div class="view-user-img">
                            ...
                            <a href="<?php echo e(route('all/profile',$enrol->user->id)); ?>" title=""><img src="<?php echo e(asset('images/user_img/'.$enrol->user['user_img'])); ?>" class="img-fluid user-img-one" alt=""></a>
                            <?php else: ?>
                            <a href="<?php echo e(route('all/profile',$enrol->user->id)); ?>" title=""><img src="<?php echo e(asset('images/default/user.png')); ?>" class="img-fluid user-img-one" alt=""></a>
                            <?php endif; ?>
                        </div>
                        <div class="view-dtl">
                            <div class="view-heading"><a href="<?php echo e(route('course.content',['id' => $enrol->courses->id, 'slug' => $enrol->courses->slug ])); ?>"><?php echo e(str_limit($enrol->courses->title, $limit = 30, $end = '...')); ?></a>
                            </div>
                            <div class="user-name">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                        ...
                                        <div class="rate text-right">
                                            <ul>
                                                ...
                                                <li><a><b><strike><?php echo e(activeCurrency()->getData()->position == 'l' ?
                                                                activeCurrency()->getData()->symbol :''); ?> <?php echo e(price_format( currency($enrol->courses->price, $from =
                                                                $currency->code, $to = Session::has('changed_currency')
                                                                ? Session::get('changed_currency') : $currency->code,
                                                                $format = false))); ?> <?php echo e(activeCurrency()->getData()->position == 'r' ?
                                                                activeCurrency()->getData()->symbol :''); ?></strike></b></a>
                                                ...
                                                <li><a><b>
                                                            <?php echo e(activeCurrency()->getData()->position == 'l' ?
                                                            activeCurrency()->getData()->symbol :''); ?> <?php echo e(price_format(
...
<div class="page-section" id="transforming">
    <div class="container wide3">
        <div class="content-element6">
            ...
            <div class="col-lg-6 col-md-6 col-5">
                <div class="view-button txt-rgt">
                    <a href="<?php echo e(url('shortcourse/view')); ?>" class="btn btn-secondary" title="View More"><?php echo e(__('View
                        More')); ?><i data-feather="chevron-right"></i>
                    </a>
                </div>
            </div>
        ...
        ?>
        <?php $__currentLoopData = $shortcorses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shortcourse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>


            <div class="item-col full-size">
                <div class="challenge-item">
                    <div class="bg-img" data-bg="<?php echo e(asset('images/course/'.$shortcourse['preview_image'])); ?>" style="background-image: url('images/course/<?php echo e($shortcourse['preview_image']); ?>');background-position: center;">
                    </div>
                    <a href="#" class="link"></a>
                    <div class="inner">
                        <h3 class="item-title"><a href="#"><?php echo e($shortcourse->title); ?></a></h3>
                        <p style="color:#fff" class="limit"><?php echo e($shortcourse->short_detail); ?></p>
                        <a href="#" class="item-country">ONLINE + OFFLINE | WHATSAPP</a>
                        <h3 class="item-title"><a href="#">&#x20B9 <?php echo e($shortcourse->price); ?></a></h3>
                        <div class="butns">
                            <a href="<?php echo e(route('user.course.show',['id' => $shortcourse->id, 'slug' => $shortcourse->slug ])); ?>">Enroll Now</a>
                        </div>
                        <div class="more_btn">
...
<div class="page-section riskwala" id="transforming">
    <div class="container wide3">
        <div class="content-element6">
            ...
            <div class="col-lg-6 col-md-6 col-5">
                <div class="view-button txt-rgt">
                    <a href="<?php echo e(url('longcourse/view')); ?>" class="btn btn-secondary" title="View More"><?php echo e(__('View
                        More')); ?><i data-feather="chevron-right"></i>
                    </a>
                </div>
            </div>
        ...
        <div class="challenges masonry flex-row item-col-2">
        <?php $__currentLoopData = $longcourses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shortcourse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="item-col full-size">
                ...
                <div class="challenge-item">
                    ...
                    <div class="inner">
                        <h3 class="item-title"><a href="#"><?php echo e($shortcourse->title); ?></a></h3>
                        <p class="limit" style="color:#fff"><?php echo e($shortcourse->short_detail); ?></p>
                ...
                <div class="facts-block text-center">
                    <div class="facts-block-one">
                        <div class="facts-block-img">
                            ...
                            <?php else: ?>
                            <img src="<?php echo e(Avatar::create($factset->title)->toBase64()); ?>" alt="course" class="img-fluid">
                            <?php endif; ?>
...
<section id="student" class="student-main-block btm-40">
    <div class="container-xl">
        <a href="<?php echo e($adv->url1); ?>" title="<?php echo e(__('Click to visit')); ?>">
            <img class="lazy img-fluid advertisement-img-one" data-src="<?php echo e(url('images/advertisement/'.$adv->image1)); ?>" alt="<?php echo e($adv->image1); ?>">
        </a>
    </div>
</section>
<?php endif; ?>
                ...
                <div class="genre-slide-image protip" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block-3<?php echo e($bundle->id); ?>">
                    <div class="view-block">
                        ...
                        <div class="view-user-img">
                            ...
                            <a href="<?php echo e(route('all/profile',$bundle->user->id)); ?>" title=""><img src="<?php echo e(asset('images/user_img/'.$bundle->user['user_img'])); ?>" class="img-fluid user-img-one" alt=""></a>
                            <?php else: ?>
                            <a href="<?php echo e(route('all/profile',$bundle->user->id)); ?>" title=""><img src="<?php echo e(asset('images/default/user.png')); ?>" class="img-fluid user-img-one" alt=""></a>
                            <?php endif; ?>
                        </div>
                        <div class="view-dtl">
                            <div class="view-heading"><a href="<?php echo e(route('bundle.detail', $bundle->id)); ?>"><?php echo e(str_limit($bundle->title, $limit = 30, $end = '...')); ?></a>
                            </div>
                            <div class="user-name">
                            ...
                            <div class="view-footer">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                        <div class="view-date">
                                            <a href="#"><i data-feather="calendar"></i> <?php echo e(date('d-m-Y',
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                        ...
                                        <div class="rate text-right">
                                            <ul>
                                                ...
                                                <li><a><b><strike><?php echo e(activeCurrency()->getData()->position == 'l' ?
                                                                activeCurrency()->getData()->symbol :''); ?><?php echo e(price_format( currency($bundle->price, $from =
                                                                $currency->code, $to = Session::has('changed_currency')
                                                                ? Session::get('changed_currency') : $currency->code,
                                                                $format = false))); ?><?php echo e(activeCurrency()->getData()->position == 'r' ?
                                                                activeCurrency()->getData()->symbol :''); ?></strike></b></a>
                            ...
                            <div class="des-btn-block">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <?php else: ?>
                                        <div class="protip-btn">
                                            <a href="" class="btn btn-secondary" title="Cart"><?php echo e(__('Purchased')); ?></a>
                                        </div>
                                        <?php endif; ?>
                                        <?php endif; ?>
                                        <?php else: ?>
...
<section id="bundle-block" class="student-main-block">
    <div class="container-xl">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-5">
                <div class="view-button txt-rgt">
                    <a href="<?php echo e(url('bundle/view')); ?>" class="btn btn-secondary" title="View More">View More<i data-feather="chevron-right"></i>
                    </a>
                </div>
            </div>
        </div>
                            ...
                            <div class="img-wishlist">
                                <div class="protip-wishlist">
                                    <ul>
                                        ...
                                        <li class="protip-wish-btn"><a href="https://calendar.google.com/calendar/r/eventedit?text=<?php echo e($bundle['title']); ?>" target="__blank" title="reminder"><i data-feather="bell"></i></a></li>

                                        <?php if(Auth::check()): ?>

                                        <li class="protip-wish-btn"><a class="compare" data-id="<?php echo e(filter_var($bundle->id)); ?>" title="compare"><i data-feather="bar-chart"></i></a></li>
                            ...
                            <div class="des-btn-block">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <?php if($enroll == NULL): ?>
                                        <div class="protip-btn">
                                            <a href="<?php echo e(url('enroll/show',$bundle->id)); ?>" class="btn btn-primary" title="Enroll Now"><i data-feather="shopping-cart"></i><?php echo e(__('Enroll
                                                Now')); ?></a>
                                        </div>
                                        <?php else: ?>
                                        <div class="protip-btn">
...
<section id="student" class="student-main-block" style="display:none">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-5">
                <div class="view-button txt-rgt">
                    <a href="<?php echo e(url('bestselling/view')); ?>" class="btn btn-secondary" title="View More">View More<i data-feather="chevron-right"></i>
                    </a>
                </div>
            </div>
        </div>
        <div id="bestseller-view-slider" class="student-view-slider-main-block owl-carousel">
            ...
            <div class="item student-view-block student-view-block-1">
                <div class="genre-slide-image <?php if($gsetting['course_hover'] == 1): ?> protip <?php endif; ?>" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block<?php echo e($best->id); ?>">
                    <div class="view-block">
                        <div class="view-img">
                            <?php if($best->courses['preview_image'] !== NULL && $best->courses['preview_image'] !== ''): ?>
                            <a href="<?php echo e(route('user.course.show',['id' => $best->courses->id, 'slug' => $best->courses->slug ])); ?>"><img data-src="<?php echo e(asset('images/course/'.$best->courses['preview_image'])); ?>" alt="course" class="img-fluid owl-lazy"></a>
                            <?php else: ?>
                            <a href="<?php echo e(route('user.course.show',['id' => $best->courses->id, 'slug' => $best->courses->slug ])); ?>"><img data-src="<?php echo e(Avatar::create($best->title)->toBase64()); ?>" alt="course" class="img-fluid owl-lazy"></a>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="view-dtl">
                            <div class="view-heading"><a href="<?php echo e(route('user.course.show',['id' => $best->courses->id, 'slug' => $best->courses->slug ])); ?>"><?php echo e(str_limit($best->courses->title, $limit = 30, $end = '...')); ?></a>
                            </div>
                            <div class="user-name">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                        ...
                                        <div class="rate text-right">
                                            <ul>
                                                ...
                                                <li><a><b><strike><?php echo e(activeCurrency()->getData()->position == 'l' ?
                                                                activeCurrency()->getData()->symbol :''); ?><?php echo e(price_format( currency($best->courses['price'], $from =
                                                                $currency->code, $to = Session::has('changed_currency')
                                                                ? Session::get('changed_currency') : $currency->code,
                                                                $format = false) )); ?><?php echo e(activeCurrency()->getData()->position == 'r' ?
                                                                activeCurrency()->getData()->symbol :''); ?></strike></b></a>
                            ...
                            <div class="img-wishlist">
                                <div class="protip-wishlist">
                                    <ul>
                                        ...
                                        <li class="protip-wish-btn"><a href="https://calendar.google.com/calendar/r/eventedit?text=<?php echo e($best['title']); ?>" target="__blank" title="reminder"><i data-feather="bell"></i></a></li>

                                        <?php if(Auth::check()): ?>

                                        <li class="protip-wish-btn"><a class="compare" data-id="<?php echo e(filter_var($best->id)); ?>" title="compare"><i data-feather="bar-chart"></i></a></li>
                            ...
                            <div class="des-btn-block">
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        <?php else: ?>
                                        <div class="protip-btn">
                                            <form id="demo-form2" method="post" action="<?php echo e(route('addtocart',['course_id' => $best->courses->id, 'price' => $best->courses->price, 'discount_price' => $best->courses->discount_price ])); ?>" data-parsley-validate class="form-horizontal form-label-left">
                                                <?php echo e(csrf_field()); ?>
                                        ...
                                        <?php if($enroll == NULL): ?>
                                        <div class="protip-btn">
                                            <a href="<?php echo e(url('enroll/show',$best->courses->id)); ?>" class="btn btn-primary" title="Enroll Now"><i data-feather="shopping-cart"></i><?php echo e(__('Enroll
                                                Now')); ?></a>
                                        </div>
                                        <?php else: ?>
                                        <div class="protip-btn">
                                            <a href="<?php echo e(route('course.content',['id' => $best->courses->id, 'slug' => $best->courses->slug ])); ?>" class="btn btn-secondary" title="Cart"><?php echo e(__('Go To Course')); ?></a>
                                        </div>
                                        <?php endif; ?>
                                        <?php endif; ?>
                                        <?php else: ?>
                                        ...
                                        <div class="img-wishlist">
                                            <div class="protip-wishlist">
                                                <ul>
                                                    ...
                                                    <?php else: ?>
                                                    <li class="protip-wish-btn-two">
                                                        <form id="demo-form2" method="post" action="<?php echo e(url('remove/wishlist', $best->id)); ?>" data-parsley-validate class="form-horizontal form-label-left">
                                                            <?php echo e(csrf_field()); ?>
                        ...
                        <div class="prime-description-under-block">
                            ...
                            <div class="main-des meeting-main-des">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                        <div class="view-time">
                                            <a href="#"><i data-feather="clock"></i> <?php echo e(date('h:i:s
            ...
            <div class="item">
                <div class="instructor-home-block text-center">
                    <div class="instructor-home-block-one">
                        ...
                        <a href="#" title=""><img src="<?php echo e(url('/images/user_img/'.$inst->user->user_img)); ?>" class="img-fluid" /></a>
                        <?php else: ?>
                        <a href="#" title=""><img src="<?php echo e(Avatar::create($inst->user->fname)->toBase64()); ?>" alt="course" class="img-fluid"></a>
                        <?php endif; ?>
                                        ...
                                        <span class="tooltiptext">
                                            <div class="instructor-home-social-icon">
                                                <ul>
                                                    ...
                                                    <li><a href="<?php echo e($inst->youtube_url); ?>"><i data-feather="youtube"></i></a></li>
                ...
                <div class="genre-slide-image <?php if($gsetting['course_hover'] == 1): ?> protip <?php endif; ?>" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block-8<?php echo e($blog->id); ?>">
                    <div class="view-block">
                        ...
                        <div class="view-user-img">
                            ...
                            <a href="<?php echo e(route('all/profile',$blog->user->id)); ?>" title=""><img src="<?php echo e(asset('images/user_img/'.$blog->user['user_img'])); ?>" class="img-fluid user-img-one" alt=""></a>
                            <?php else: ?>
                            <a href="<?php echo e(route('all/profile',$blog->user->id)); ?>" title=""><img src="<?php echo e(asset('images/default/user.png')); ?>" class="img-fluid user-img-one" alt=""></a>
                            <?php endif; ?>
                            ...
                            <span class="tooltiptext">
                                <div class="instructor-home-social-icon">
                                    <ul>
                                        ...
                                        <li><a href="<?php echo e($blog->user->twitter_url); ?>"><i data-feather="twitter"></i></a>
                                        </li>
                                        <li><a href="<?php echo e($blog->user->youtube_url); ?>"><i data-feather="youtube"></i></a>
                                        </li>
            ...
            <div class="col-lg-2 col-md-4 col-sm-4 col-6">
                ...
                <!-- <a href="<?php echo e(route('category.page',['id' => $t->id, 'category' => str_slug(str_replace('-','&',$t->slug))])); ?>">
                        <div class="image-overlay">
                            <span><i class="fa <?php echo e($t['icon']); ?>"></i><?php echo e($t['title']); ?>

                                <div class="categories-img-count"><?php echo e($t->courses->count()); ?> <?php echo e(__('Courses')); ?></div>
                            </span>
                         </div>
                        <?php if($t['cat_image'] == !NULL): ?>
                        <img src="<?php echo e(asset('images/category/'.$t['cat_image'])); ?>">
...
<section id="testimonial" class="testimonial-main-block">
    <div class="container-xl">
        <h4 class="test_heading"><?php echo e(__('What People are Saying About Us')); ?></h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                            <div class="testimonial-name">
                                <h5 class="testimonial-heading"><?php echo e($tes['client_name']); ?></h5>
                                <p class="testimonial-para"><?php echo e($tes['designation']); ?></p>
                            </div>
...
<section id="video" class="video-main-block">
    <div class="container-fluid">
        <div class="video-block">
            ...
            <img src="<?php echo e(url('/images/videosetting/'.$videosetting->image)); ?>" class="img-fluid" />
            <?php else: ?>
            <img src="<?php echo e(Avatar::create($videosetting->tittle)->toBase64()); ?>" alt="course" class="img-fluid">
            <?php endif; ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-5">
                <div class="instructor-button txt-rgt">
                    <a href="<?php echo e(route('allinstructor/view')); ?>" class="btn btn-secondary" title="All Instructor"><?php echo e(__('All Instructor')); ?><i data-feather="chevron-right"></i>
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="item">
                <div class="instructor-home-block text-center">
                    <div class="instructor-home-block-one">
                        ...
                        <?php else: ?>
                        <a href="#" title=""><img src="<?php echo e(Avatar::create($inst->fname)->toBase64()); ?>" alt="course" class="img-fluid"></a>
                        <?php endif; ?>
                        <div class="instructor-home-hover-icon">
                            <ul>
                                <li>
    ...
    <div class="container-fluid p-0">
        <div class="get-started-block">
            <div class="get-started-bg-image">
                ...
                <img src="<?php echo e(url('/images/getstarted/'.$get_enable->image)); ?>" class="img-fluid" />
                <?php else: ?>
                <img src="<?php echo e(Avatar::create($get_enable->heading)->toBase64()); ?>" alt="course" class="img-fluid">
                <?php endif; ?>
                <div class="overlay-bg"></div>
            </div>
            <div class="get-started-dtl text-center">
                <h1 class="get-started-title text-white mb-2"><?php echo e($get_enable->heading); ?></h1>
                <h4 class="get-started-sub-title text-white"><?php echo e($get_enable->sub_heading); ?></h4>
...
<?php endif; ?>
<?php if( $hsetting->instructor_enable == 1 && !$institute->isEmpty() && isset($inst->slug)): ?>
<section id="instructor-home" class="instructor-home-main-block">
    <div class="container-xl">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-7">
            ...
            <div class="item">
                <div class="instructor-home-block text-center">
                    <div class="instructor-home-block-one">
                        ...
                        <?php else: ?>
                        <a href="<?php echo e(route('ins.sluging',['id' => $inst->id, 'slug' => $inst->slug ])); ?>" title=""><img src="<?php echo e(Avatar::create($inst->fname)->toBase64()); ?>" alt="course" class="img-fluid"></a>
                        <?php endif; ?>
                        <div class="instructor-home-hover-icon">
                            <ul>
                                <li>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('theme.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views/home.blade.php ENDPATH**/ ?>