      ...
      <div class="card m-b-30">
          ...
          <form action="<?php echo e(url('course/')); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-md-4" style="display:none;">
                ...
                <input name="language_id" value="1"></input>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="input-group mb-3">
              <input type="file" class="form-control" id="image" name="preview_image">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views/admin/course/insert.blade.php ENDPATH**/ ?>