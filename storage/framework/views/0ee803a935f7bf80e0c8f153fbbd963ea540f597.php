...
<?php $__env->startSection('title','Create a new instructor'); ?>
    ...
    <div class="col-lg-12">
      <div class="card m-b-30">
        <div class="card-header">
          <h5 class="box-tittle"><?php echo e(__('Add')); ?> <?php echo e(__('Instructor')); ?></h5>
        </div>
        <div class="card-body">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group" style="display:none;">
                  ...
                  <select class="form-control select2" name="role" required>
                    ...
                    <!--<option value="instructor"><?php echo e(__('Instructor')); ?></option>-->
                  </select>
                </div>
                <div class="form-group">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <small class="text-muted"><i class="fa fa-question-circle"></i>
                    <?php echo e(__('Recommendedsize')); ?> (410 x 410px)</small>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/magic.bizz-manager.com/public_html/resources/views/admin/allinstructor/adduser.blade.php ENDPATH**/ ?>