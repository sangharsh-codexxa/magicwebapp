        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4">
                ...
                <div class="about-home-product">
                    ...
                    <div id="bar-fixed">
                        <div class="about-home-dtl-training" style="box-shadow: 0 5px 12px 0 rgba(0,0,0,.1)!important;border-radius: 0.9375rem!important;">
                                ...
                                <?php if(Auth::check()): ?>
                                    ...
                                    <?php if(Auth::User()->role == "admin"): ?>
                                        <div class="about-home-btn btm-20" >
                                            <a href="<?php echo e(route('course.content',['id' => $course->id, 'slug' => $course->slug ])); ?>" 
                ...
                <br>
                <div class="about-content-sidebar" style="box-shadow: 0 5px 12px 0 rgba(0,0,0,.1)!important;border-radius: 0.9375rem!important;">
                    <div class="container-xl">
                        ...
                        <?php if($course->user['user_img'] !== NULL && $course->user['user_img'] !== ''): ?>
                            ...
                            <img src="<?php echo e(asset('images/default/user.png')); ?>" class="img-fluid" alt="">
                                <?php endif; ?>
                                <h3 class="about-content-heading"><?php echo e(optional($course->user)['fname']); ?> <?php echo e(optional($course->user)['lname']); ?></h3>
                        </div>
                        <div class="ratings" style="color: #818894!important;">
                            <?php
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <a style="box-shadow:0 3px 6px 0 rgb(42 106 255 / 30%)" href="<?php echo e(route('instructor.profile', ['id' => $course->user->id, 'name' => $fullname] )); ?>" class="btn btn-primary" title="course"><?php echo e(__('Profile')); ?></a>
                            </div>
            ...
            <div class="col-lg-8 col-md-8" >
                <?php if($whatlearns->isNotEmpty()): ?>
                    <div class="product-learn-block" >
                        <h3 class="product-learn-heading" style="color:#fff;"><?php echo e(__('Whatlearn')); ?></h3>
                        <div class="row">
                ...
                <div class="course-content-block btm-30 top-20" >
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-8">
                            <h3 class="course-content"><?php echo e(__('CourseContent')); ?></h3>
                        </div>
                        <!--
                                    ...
                                    <div class="card-header" id="headingTwo<?php echo e($chapter->id); ?>">
                                        <div class="mb-0">
                                            <button class="btn btn-link" data-toggle="collapse" data-target="#collapseTwo<?php echo e($chapter->id); ?>" aria-expanded="<?php echo e($key == 0 ? 'true' : 'false'); ?>" aria-controls="collapseTwo">
                                                ...
                                                <div class="row">
                                                <div class="col-lg-8 col-6" style="font-weight: 600;">
               ...
               <?php
                ...
                <div class="students-bought btm-30" style="display:none">
                ...
                <div class="about-instructor-block" style="display:none">
...
<?php echo $__env->make('theme.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views\front\course_detail.blade.php ENDPATH**/ ?>