                  ...
                  <div class="table-responsive">
                      ...
                      <td><div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                            ...
                            <!-- <a class="dropdown-item" href="<?php echo e(url('assignment/'.$assign->id)); ?>"><i class="feather icon-eye mr-2"></i><?php echo e(__('View')); ?></a> -->
                            <button type="button" class="dropdown-item" data-toggle="modal" data-target="#exampleStandardModal<?php echo e($assign->id); ?>">
                              <i class="feather icon-eye mr-2"></i><?php echo e(__('View')); ?>

                            </button>
                            <?php endif; ?>
                            <a class="dropdown-item" href="<?php echo e(asset('files/assignment/'.$assign->assignment)); ?>"  download="<?php echo e($assign->assignment); ?>"><i class="feather icon-download mr-2"></i><?php echo e(__('Download')); ?></a>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('assignment.delete')): ?>

                            <a class="dropdown-item btn btn-link" data-toggle="modal" data-target="#delete<?php echo e($assign->id); ?>" >
                                        ...
                                        <div class="table-responsive">
                                          <table class="table table-borderless mb-0 user-table">
                                            <tbody>
                                              ...
                                              <tr>
                                                <th scope="row" class="p-1"><?php echo e(__('CourseChapter')); ?> : </th>
                                                <td class="p-1"> <?php echo e($assign->chapter->chapter_name); ?></td>
                                              </tr>
                                              <tr>
                                                <th scope="row" class="p-1"><?php echo e(__('AssignmentTitle')); ?> : </th>
                                                <td class="p-1"><?php echo e($assign->title); ?></td>
                                              </tr>
                                              <tr>
                                                <th scope="row" class="p-1"><?php echo e(__('Assignment')); ?> : </th>
                                                <td class="p-1"> <a href="<?php echo e(asset('files/assignment/'.$assign->assignment)); ?>" download="<?php echo e($assign->assignment); ?>"><?php echo e(__('Download')); ?> <i class="fa fa-download"></i></a></td>
                                              </tr>
                                            </tbody>
                                          </table>
                                        </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views\admin\course\assignment\index.blade.php ENDPATH**/ ?>