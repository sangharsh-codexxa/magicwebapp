          ...
          <table id="" class="displaytable table table-striped table-bordered w-100">
            ...
            <tbody>
              ...
              <tr>
                ...
                <!-- ================================== -->
                <td>
                  <button type="button" class="btn btn-rounded <?php echo e($an->status == '1' ? 'checked' : '' ? 'btn-success-rgba' : 'btn-danger-rgba'); ?>" data-toggle="modal" data-target="#myModal">
                      <?php if( $an->status): ?>
...
<?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views/admin/course/announsment/index.blade.php ENDPATH**/ ?>