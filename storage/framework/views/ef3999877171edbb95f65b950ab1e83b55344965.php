<div class="leftbar">
                ...
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade active show" id="v-pills-dashboard" role="tabpanel"
                        ...
                        <ul class="vertical-menu">
                            ...
                            <!-- Course start  -->
                            <li
                                class="<?php echo e(Nav::isResource('category')); ?> <?php echo e(Nav::isResource('subcategory')); ?> <?php echo e(Nav::isResource('childcategory')); ?> <?php echo e(Nav::isResource('course')); ?> <?php echo e(Nav::isResource('courselang')); ?>">
                                <a href="javaScript:void();">
                                    <i class="feather icon-book text-secondary"></i>
                                    <span><?php echo e(__('Course')); ?></span><i
                        ...
                        <li class="<?php echo e(Nav::isResource('featurecourse')); ?>">
                            <a class="nav-link" href="<?php echo e(url('featurecourse')); ?>">
                        ...
                        <li
                            ...
                            <a href="javaScript:void();">
                                <i
                                    class="feather icon-users text-secondary"></i><span><?php echo e(__('MultipleInstructor')); ?></span><i
                                    class="feather icon-chevron-right"></i>
                            </a>
                            <ul class="vertical-submenu">
                        ...
                        <li
                            class="<?php echo e(Nav::isResource('instructorquestion')); ?> <?php echo e(Nav::isResource('instructoranswer')); ?>">
                            <a href="javaScript:void();">
                                <i class="feather icon-help-circle text-secondary"></i><span><?php echo e(__('Question')); ?>

                                    / <?php echo e(__('Answer')); ?></span><i
                                    class="feather icon-chevron-right"></i>
                            </a>
                            <ul class="vertical-submenu">
                        ...
                        <li class="<?php echo e(Nav::isResource('userenroll')); ?>">
                            <a class="nav-link" href="<?php echo e(url('userenroll')); ?>">
                        ...
                        <li class="<?php echo e(Nav::isResource('instructor/announcement')); ?>">
                            <a class="nav-link" href="<?php echo e(url('instructor/announcement')); ?>">
                                <i
                        ...
                        <li class="<?php echo e(Nav::isResource('pending.payout')); ?> <?php echo e(Nav::isRoute('admin.completed')); ?>">
                            <a href="javaScript:void();">
                                <i
                                    class="feather icon-dollar-sign text-secondary"></i><span><?php echo e(__('MyRevenue')); ?></span><i
                                    class="feather icon-chevron-right"></i>
                            </a>
                            <ul class="vertical-submenu">
                        ...
                        <li class="<?php echo e(Nav::isResource('instructor.pay')); ?>">
                            <a class="nav-link" href="<?php echo e(route('instructor.pay')); ?>">
                                <i
                        ...
                        <li class="<?php echo e(Nav::isResource('vacation.view')); ?>">
                            <a class="nav-link" href="<?php echo e(route('vacation.view')); ?>">
                                <i
    ...
    <!-- End Sidebar -->
</div><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views\instructor\layouts\sidebar.blade.php ENDPATH**/ ?>