            ...
            <table id="datatable-buttons" class="table table-striped table-bordered">
              ...
              <tbody id="sortable">
                ...
                <tr class="sortable" id="id-<?php echo e($cat->id); ?>">
                  ...
                  <td>
                    <button type="button" class="btn btn-rounded <?php echo e($cat->featured == '1' ? 'checked' : '' ? 'btn-success-rgba' : 'btn-danger-rgba'); ?>">
                      <?php if( $cat->featured): ?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="demo-form2" method="post" action="<?php echo e(url('category/')); ?>" data-parsley-validate
          ...
          <div class="row">
            <div class="col-md-12">
              <label for="c_name"><?php echo e(__('Name')); ?>:<sup class="redstar">*</sup></label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/magic.bizz-manager.com/public_html/resources/views/admin/category/view.blade.php ENDPATH**/ ?>