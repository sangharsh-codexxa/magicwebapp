...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(url('installer/css/select2.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(url('installer/css/bootstrap-toggle.min.css')); ?>">
  ...
  <body>
    ...
    <div class="preL display-none">
      <div class="preloader3 display-none"></div>
        ...
        <div class="card-header">
          ...
          <form autocomplete="off" enctype="multipart/form-data" action="<?php echo e(route('store.step5')); ?>" id="step5form" method="POST" class="database-validation" novalidate>
            <?php echo csrf_field(); ?>
            ...
            <div class="form-row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <div>
                  <small>⦿ <?php echo e(__(('Removing public from URL is only works when you have installed script in main domain.'))); ?></small>
                  <br>

                  <small>⦿ <?php echo e(__("Do not remove public when you have Installed script in subdomin or subfolders.")); ?></small>
                </div>
              </div>
    ...
    <script src="<?php echo e(url('installer/js/select2.min.js')); ?>"></script>
    <script src="<?php echo e(url('installer/js/bootstrap-toggle.min.js')); ?>"></script>
...
</html><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views\install\step5.blade.php ENDPATH**/ ?>