        ...
        <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" class="required" name="title"
                                placeholder="Halloween Sale" value="<?php echo e(old('title')); ?>">
                        </div>

                        <div class="form-group col-md-6">
                            <label for=""><?php echo e(__("Background image:")); ?> <span class="text-danger">*</span> </label>
                            <div class="input-group ">
                                ...
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="inputGroupFile01"><?php echo e(__('Choose background image')); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="detail" id="detail" cols="30" rows="10"><?php echo e(old("detail")); ?></textarea>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views\admin\flashsale\create.blade.php ENDPATH**/ ?>