...
<?php $__env->slot('heading'); ?>
   <?php echo e(__('Add jitsi meeting')); ?>

<?php $__env->endSlot(); ?>
<?php $__env->slot('menu1'); ?>
   <?php echo e(__('jitsi meetings')); ?>

<?php $__env->endSlot(); ?>
<?php $__env->slot('menu2'); ?>
<?php echo e(__('Add jitsi meetings')); ?>

<?php $__env->endSlot(); ?>
<?php $__env->slot('button'); ?>
<div class="col-md-4 col-lg-4">
  <div class="widgetbar">
    <a href="<?php echo e(url('jitsi-dashboard')); ?>" class="btn btn-primary-rgba"><i class="feather icon-arrow-left mr-2"></i><?php echo e(__("Back")); ?></a>
  </div>                        
</div>
<?php $__env->endSlot(); ?>
    ...
    <div class="col-lg-12">
      <div class="card m-b-30">
        <div class="card-header">
          <h5 class="card-title"><?php echo e(__('Add Facts jitsimeeting')); ?></h5>
        </div>
        <div class="card-body">
			<form autocomplete="off" action="<?php echo e(route('jitsi.meeting.save')); ?>" method="POST" enctype="multipart/form-data">
					...
					<div class="row">
						...
						<div class="form-group col-md-6">
						<label for="exampleInputDetails"><?php echo e(__('LinkByCourse')); ?>:</label><br>
					...
					<div class="form-group col-md-6">
                        ...
                        <button type="submit" class="btn btn-primary-rgba"><i class="fa fa-check-circle"></i>
                            <?php echo e(__('Create Meeting')); ?></button>
                    </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views\admin\jitsimeeting\create.blade.php ENDPATH**/ ?>