...
<div class="modal fade" id="myModal" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="demo-form2" method="post" action="<?php echo e(url('workshop/store')); ?>" data-parsley-validate
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <textarea placeholder=" Please Enter Description" type="text" class="form-control" name="description"
                required=""></textarea>
            </div>
          </div>
          <br>
          ...
          <div class="row">
            <div class="col-md-4">
              <label for="c_name"><?php echo e(__('Date')); ?>:<sup class="redstar">*</sup></label>
              <input placeholder=" Select Date" type="date" class="form-control" name="date"
                required="">
            </div>
            <div class="col-md-4">
              <label for="c_name"><?php echo e(__('Time')); ?>:<sup class="redstar">*</sup></label>
              <input placeholder=" Select time" type="time" class="form-control" name="time"
                required="">
            </div>
          </div>
          <br>
          ...
          <div class="col-md-4">
            ...
            <div class="col-md-8">
              ...
              <input placeholder=" Please Enter Venue" type="text" class="form-control" name="venue"
                required="">
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\magic\resources\views/admin/workshop/index.blade.php ENDPATH**/ ?>