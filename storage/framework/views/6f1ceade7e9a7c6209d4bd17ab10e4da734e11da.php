        ...
        <div class="row smallscreen-search-block">
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="row col-lg-10 col-md-4 col-sm-12">
                        <div class=" col-lg-9 col-md-7 navigation" style="    margin: auto 0;">
                            <div id="cssmenu">
                                <ul>
                                    <!--<li><a href="#" title="Categories"><i data-feather="grid"></i><?php echo e(__('Categories')); ?></a>-->
                                    ...
                                    <li class="has-sub"><span class="submenu-button"></span>
                                    	<a href="#" title="Categories">WELL-BEING</a>
                                    
                                    	<ul>
                                    		<li class="has-sub"><span class="submenu-button"></span><a
                                    				href="http://magic.codingwala.com/browse/category?id=1&amp;category=Testing" title="Testing"><i
                                    					class="fa fa-address-book-o rgt-20"></i>OPTION <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    					height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    					stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right float-right">
                                    					<polyline points="9 18 15 12 9 6"></polyline>
                                    				</svg></a>
                                    		</li>
                                    		<li class="has-sub"><span class="submenu-button"></span><a
                                    				href="http://magic.codingwala.com/browse/category?id=2&amp;category=Software%20Developement"
                                    				title="Software Developement"><i class="fa fa-adjust rgt-20"></i>OPTION</a>
                                    ...
                                    <li class="has-sub"><span class="submenu-button"></span>
                                    	<a href="#" title="Categories">LEARNING</a>
                                    ...
                                    <li class="has-sub"><span class="submenu-button"></span>
                                    	<a href="#" title="Categories">GUIDANCE</a>
                                    ...
                                    <li class="has-sub"><span class="submenu-button"></span>
                                    	<a href="#" title="Categories">RETREATS</a>
                                    ...
                                    <li class="has-sub"><span class="submenu-button"></span>
                                    	<a href="#" title="Categories">ARTICLES</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-3" style="padding-top:30px;">
                            <?php if(auth()->guard()->guest()): ?>
                            <div class="row">
                                <!--<div class="col-lg-9 col-md-6" style="display:none">-->
                                ...
                                <div class="col-lg-1">
                                    <div class="Login-btn" style="display:flex">
                                        <a href="<?php echo e(route('login')); ?>" class="btn btn-secondary" title="login"><?php echo e(__('Login')); ?></a>
                                        <a style="margin-left:10px;border-radius:20px" href="<?php echo e(route('register')); ?>" class="btn btn-primary" title="register"><?php echo e(__('btn2')); ?></a>
                                            ...
                                            <ul>
                                                <li><a><i data-feather="align-justify"></i></a>
                                                    <ul>
                                                        ...
                                                        <?php if($menu->link_by == 'url'): ?>
                                                        <li><a href="<?php echo e($menu->url); ?>" title="Home"><?php echo e($menu->title); ?></a></li>
                                                        <?php endif; ?>
                                                        <?php if($menu->link_by == 'page'): ?>
                                                        <li><a href="<?php echo e(route('page.show', $menu->page->slug)); ?>" title="Home"><?php echo e($menu->title); ?></a></li>
                                                        <?php endif; ?>
                                                        <?php endif; ?>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </ul>
                                    ...
                                    <div class="my-container">
                                      <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right User-Dropdown U-open" aria-labelledby="dropdownMenu1">
                                            ...
                                            <a style="display:none;" target="_blank" href="<?php echo e(url('/admins')); ?>"><li><i data-feather="pie-chart"></i><?php echo e(__('AdminDashboard')); ?></li></a>
                                           
                                            <?php endif; ?>
                                            <?php if(Auth::User()->role == "instructor"): ?>
            
                                            <a style="display:none;"  target="_blank" href="<?php echo e(url('/instructor')); ?>"><li><i data-feather="pie-chart"></i><?php echo e(__('InstructorDashboard')); ?></li></a>
                                            <?php endif; ?>
                                            ...
                                            <?php if(Auth::User()->role == "user"): ?>
                                            <?php if($gsetting->instructor_enable == 1): ?>
                                            <a style="display:none;"  href="#" data-toggle="modal" data-target="#myModalinstructor" title="Become An Instructor"><li><i data-feather="shield"></i><?php echo e(__('BecomeAnInstructor')); ?></li></a>
            
                                            <?php endif; ?>
                                    
                                            <?php endif; ?>
            
                                            <a style="display:none;"  href="<?php echo e(route('flash.deals')); ?>"><li><i data-feather="battery-charging"></i><?php echo e(__('Flash Deals')); ?></li></a>
            
            
                                            <?php if(env('ENABLE_INSTRUCTOR_SUBS_SYSTEM') == 1): ?>
            
                                            <?php if(Auth::User()->role == "instructor"): ?>
                                            <a style="display:none;"  href="<?php echo e(route('plan.page')); ?>"><li><i data-feather="tag"></i><?php echo e(__('InstructorPlan')); ?></li></a>
                                            <?php endif; ?>
                                            <?php endif; ?>
                                            ...
                                            <?php if(Auth::User()->role == "user" || Auth::User()->role == "instructor"): ?>
                                            <?php if($gsetting->device_control == 1): ?>
                                            <a style="display:none;"  href="<?php echo e(route('active.courses')); ?>" title="Watchlist"><li><i data-feather="framer"></i><?php echo e(__('Watchlist')); ?></li></a>
                                            <?php endif; ?>
                                            <?php endif; ?>
            
            
                                            <?php if($gsetting->donation_enable == 1): ?>
                                            <a style="display:none;"  target="__blank" href="<?php echo e($gsetting->donation_link); ?>" title="Donation"><li><i data-feather="framer"></i><?php echo e(__('Donation')); ?></li></a>
                                            <?php endif; ?>
                                            ...
                                            <?php if(isset($wallet_settings) && $wallet_settings->status == 1): ?>
                                            <a style="display:none;" href="<?php echo e(url('/wallet')); ?>"><li><i class="icon-wallet icons"></i><?php echo e(__('MyWallet')); ?></li></a>
                                            <?php endif; ?>
            
                                            <?php if(isset($affiliate) && $affiliate->status == 1): ?>
                                            <a style="display:none;" href="<?php echo e(route('get.affiliate')); ?>"><li><i data-feather="users"></i><?php echo e(__('Affiliate')); ?></li></a>
                                            <?php endif; ?>
            
                                            <?php endif; ?>
            
                                            <a style="display:none;"  href="<?php echo e(route('compare.index')); ?>"><li><i data-feather="bar-chart"></i><?php echo e(__("Compare")); ?></li></a>
                                            ...
                                            <?php if(Module::find('Forum') && Module::find('Forum')->isEnabled()): ?>
                                                ...
                                                <?php endif; ?>
                                            <?php endif; ?>
                                            <a style="display:none;"  href="<?php echo e(route('my.leaderboard')); ?>"><li><i class="icon-chart icons"></i><?php echo e(__('MyLeaderboard')); ?></li></a>
                                            <?php if(Auth::User()->role == "user"): ?>
                                            <a style="display:none;"  href="<?php echo e(route('studentprofile')); ?>"><li><i data-feather="share"></i><?php echo e(__('Share profile')); ?></li></a>
                                            <?php endif; ?>
                                            <a style="display:none;"  href="<?php echo e(route('affilate.report')); ?>"><li><i data-feather="users"></i><?php echo e(__('Affiliate Dashboard')); ?></li></a>
                                            <a  style="display:none;" href="<?php echo e(route('batch.front')); ?>"><li><i data-feather="book-open"></i><?php echo e(__('Batch')); ?></li></a>
...
<?php echo $__env->make('instructormodel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codingwa/magic.codingwala.com/resources/views/theme/nav.blade.php ENDPATH**/ ?>