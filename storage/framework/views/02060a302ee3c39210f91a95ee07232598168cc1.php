        ...
        <div class="bg-info-rgba col-md-12 ml-3 mr-3 mb-3">
            ...
            <div class="col-md-12">
                <div class="row" style="<?php echo e($setting['map_enable'] == 'map' ? '' : 'display:none'); ?>" id="sec1_one">
                    <div class="col-md-4">
                        <label class="text-dark" for="map_lat"><?php echo e(__('MapLatitude')); ?>:</label>
                    ...
                    <div class="col-md-4">
                        <label class="text-dark" for="map_long"><?php echo e(__('MapLongitude')); ?>:</label>
                ...
                <div class="col-md-4">
                    ...
                    <div style="<?php echo e($gsetting->watch_enable == 1 ? '' : 'display: none'); ?>" id="update-password">
                        <div class="form-group">
                          ...
                          <input type="number" name="watch_time" value="<?php echo e($gsetting->watch_time); ?>" class="form-control"
...
<script>
    ...
    <?php $__env->stopSection(); ?> <?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views\admin\setting\genral.blade.php ENDPATH**/ ?>