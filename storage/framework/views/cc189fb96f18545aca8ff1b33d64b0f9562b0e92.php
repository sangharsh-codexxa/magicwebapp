                                    ...
                                    <?php if(Auth::User()->role == "admin"): ?>
                                        <div class="about-home-btn btm-20" >
                                            <!--<a href="<?php echo e(route('course.content',['id' => $course->id, 'slug' => $course->slug ])); ?>" class="btn btn-secondary" title="course"><?php echo e(__('Go To Course')); ?></a>-->
                                                                                 <a href="#" class="btn btn-secondary" title="course"><?php echo e(__('Go To Course')); ?></a>
            ...
            <div class="col-lg-8 col-md-8" >
                <?php if($whatlearns->isNotEmpty()): ?>
                    <div class="product-learn-block" >
                        <h3 class="product-learn-heading"><?php echo e(__('Whatlearn')); ?></h3>
                        <div class="row">
                ...
                <div class="course-content-block btm-30 top-20" >
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-8">
                            <h3><?php echo e(__('CourseContent')); ?></h3>
                        </div>
                        <!--
...
<?php echo $__env->make('theme.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codingwa/magic.codingwala.com/resources/views/front/course_detail.blade.php ENDPATH**/ ?>