...
<?php $__env->startSection('title','Edit Google meet'); ?>
...
<?php echo e(__(' Edit Google meet')); ?>

<?php $__env->endSlot(); ?>

<?php $__env->slot('button'); ?>
<div class="col-md-4 col-lg-4">
	<a href="<?php echo e(url(('googlemeet/dashboard'))); ?>" class="float-right btn btn-primary mr-2"><i
		...
		<div class="col-lg-12">
			<div class="card m-b-30">
				<div class="card-header">
					<h5 class="box-title"><?php echo e(__('Edit')); ?> <?php echo e(__('Google meet')); ?></h5>
				</div>
				<div class="card-body ml-2">
					<form autocomplete="off" action="<?php echo e(route('googlemeet.update',$googlemeetedit['meeting_id'])); ?>"
						...
						<div class="form-group">
						 ...
						 <div class="form-group">
							...
							<input   id="link_by" type="checkbox"  class="custom_toggle"   name="link_by" <?php echo e(isset($googlemeetedit['link_by']) == 'course' ? 'checked' : ''); ?> />
			              ...
			              <div class="form-group" style="<?php echo e(isset($googlemeetedit['link_by']) == 'course' ? '' : 'display:none'); ?>" id="sec1_one">
							...
							<option <?php echo e(optional($googlemeetedit)['course_id'] == $caat->id ? 'selected' : ""); ?> value="<?php echo e($caat->id); ?>"><?php echo e($caat->title); ?></option>
						    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
			                </select>
			              </div>
						...
						<div class="form-group">
							<label>
								<?php echo e(__('MeetingTopic')); ?>:<sup class="redstar">*</sup>
							</label>

							<input type="text" name="topic" value="<?php echo e($googlemeetedit['meeting_title']); ?>"
						...
						<div class="form-group col-md-12" id="sec4_four">
							...
							<div class="input-group" id='datetimepicker1'>
								<input type="text" name="start_time" value="<?php echo e($googlemeetedit['start_time']); ?> "
						...
						<div class="form-group col-md-12" id="sec5_four">
							<label>
								<?php echo e(__('EndTime')); ?>:<sup class="redstar">*</sup>
							</label>
							<div class="input-group" id='datetimepicker1'>
								<input type="text" name="end_time" value="<?php echo e($googlemeetedit['end_time']); ?>"
						...
						<div class="form-group" id="sec3_three">
							...
							<input type="number" min="1" value="<?php echo e($googlemeetedit['duration']); ?>" name="duration"
								class="form-control">
						</div>
						...
						<div class="form-group">
							<label>
								<?php echo e(__('Meeting')); ?> <?php echo e(__('Agenda')); ?>:<sup
									class="redstar">*</sup>
							</label>
							<input type="text" name="description" value="<?php echo e($googlemeetedit['agenda']); ?>"
								class="form-control" required>
						</div>
						...
						<div class="form-group">
							...
							<select class="form-control select2" name="timezone">
								<option value="<?php echo e($googlemeetedit['timezone']); ?>"><?php echo e($googlemeetedit['timezone']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views\googlemeet\edit.blade.php ENDPATH**/ ?>