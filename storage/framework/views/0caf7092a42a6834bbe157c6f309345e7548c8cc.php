<div class="leftbar sidebar-two" style="background-image: url('images/navbar.png')">
            ...
            <ul class="vertical-menu">
              <div class="logobar">
                <a href="<?php echo e(url('/')); ?>" class="logo logo-large">
                  <img style="object-fit:scale-down;" src="<?php echo e(url('images/logo/'.$gsetting->footer_logo)); ?>" class="img-fluid" alt="logo">
                </a>
              </div>
              ...
              <li class="<?php echo e(Nav::isRoute('user.index')); ?> <?php echo e(Nav::isRoute('user.add')); ?> <?php echo e(Nav::isRoute('user.edit')); ?><?php echo e(Nav::isRoute('alluser.index')); ?> <?php echo e(Nav::isRoute('alluser.add')); ?> <?php echo e(Nav::isRoute('alluser.edit')); ?><?php echo e(Nav::isRoute('allinstructor.index')); ?> <?php echo e(Nav::isRoute('allinstructor.add')); ?> <?php echo e(Nav::isRoute('allinstructor.edit')); ?><?php echo e(Nav::isResource('roles')); ?>">
                <a href="javaScript:void();" class="menu"><i class="feather icon-users text-secondary"></i>
                  <span><?php echo e(__('Users')); ?>

                    <div class="sub-menu truncate"><?php echo e(__('All Users, All Students, All Instructors, Roles And
                      Permission')); ?></div>
                  </span>
                ...
                <ul class="vertical-submenu">
                  ...
                  <li>
                    <a class="<?php echo e(Nav::isResource('user')); ?>" href="<?php echo e(route('user.index')); ?>"><?php echo e(__('All Users')); ?></a>
                  </li>
                  <?php endif; ?>
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Alluser.view')): ?>
                  <li>
                    <a class="<?php echo e(Nav::isResource('allusers')); ?>" href="<?php echo e(route('allusers.index')); ?>"><?php echo e(__('All
                      Students')); ?></a>
                  </li>
                  <?php endif; ?>
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Allinstructor.view')): ?>
                  <li>
                    <a class="<?php echo e(Nav::isResource('allinstructor')); ?>" href="<?php echo e(route('allinstructor.index')); ?>"><?php echo e(__('All
                      Instructors')); ?></a>
                  </li>
                  <?php endif; ?>
                  <li>
                    <a class="<?php echo e(Nav::isResource('alladmin')); ?>" href="<?php echo e(route('alladmin.index')); ?>"><?php echo e(__('All Admins')); ?></a>
                  </li>
                  <li>
                    <a class="<?php echo e(Nav::isResource('alladmin')); ?>" href="<?php echo e(route('user.verify')); ?>"><?php echo e(__('Verify User')); ?></a>
                  </li>
                  <li>
                    <a class="<?php echo e(Nav::isResource('roles')); ?>" href="<?php echo e(route('roles.index')); ?>"><?php echo e(__('Roles And
                      Permission')); ?></a>
                  </li>
              ...
              <li style="display:none" class="<?php echo e(Nav::isResource('plan/subscribe/settings')); ?> <?php echo e(Nav::isResource('subscription/plan')); ?>  <?php echo e(Nav::isRoute('all.instructor')); ?> <?php echo e(Nav::isResource('requestinstructor')); ?>">
                <a href="javaScript:void();" class="menu"><i class="feather icon-user text-secondary"></i>
                  <span><?php echo e(__('Instructors')); ?>

                    <div class="sub-menu truncate"><?php echo e(__('All Instructor Request, Pending Request, Instructor
                      Subscription, Instructor Plan, Multiple Instructor, Instructor Payout')); ?></div>
                  </span>
                  <i class="feather icon-chevron-right"></i>
                </a>
                <ul class="vertical-submenu">
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('instructorrequest.view')): ?>
                  <li class="<?php echo e(Nav::isRoute('all.instructor')); ?>"><a href="<?php echo e(route('all.instructor')); ?>"><?php echo e(__('All')); ?>
                  ...
                  <li class="<?php echo e(Nav::isResource('requestinstructor')); ?>"><a href="<?php echo e(url('requestinstructor')); ?>"><?php echo e(__('Pending')); ?>

                      <?php echo e(__('Request')); ?></a></li>
                  <?php endif; ?>
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('instructor-plan-subscription.view')): ?>
                  <li class="<?php echo e(Nav::isResource('plan/subscribe/settings')); ?>"><a href="<?php echo e(url('plan/subscribe/settings')); ?>"><?php echo e(__('Instructor')); ?>

                      <?php echo e(__('Subscription')); ?></a></li>
                  <?php endif; ?>
                  <?php if(env('ENABLE_INSTRUCTOR_SUBS_SYSTEM') == 1): ?>
                  <li class="<?php echo e(Nav::isResource('subscription/plan')); ?>"><a href="<?php echo e(url('subscription/plan')); ?>"><?php echo e(__('InstructorPlan')); ?></a>
                  </li>
                  <?php endif; ?>
                  ...
                  <li class="<?php echo e(Nav::isRoute('allrequestinvolve')); ?> <?php echo e(Nav::isRoute('involve.request.index')); ?> <?php echo e(Nav::isRoute('involve.request')); ?>">
                    <a href="javaScript:void();">
                      <span><?php echo e(__('MultipleInstructor')); ?></span>
                    </a>
                    <ul class="vertical-submenu">

                      <li class="<?php echo e(Nav::isRoute('allrequestinvolve')); ?>"><a href="<?php echo e(route('allrequestinvolve')); ?>"><?php echo e(__('RequesttoInvolve')); ?></a>
                      </li>
                      <li class="<?php echo e(Nav::isRoute('involve.request.index')); ?>"><a href="<?php echo e(route('involve.request.index')); ?>"><?php echo e(__('InvolvementRequests')); ?></a>
                      </li>
                      <li class="<?php echo e(Nav::isRoute('involve.request')); ?>"><a href="<?php echo e(route('involve.request')); ?>"><?php echo e(__('InvolvedInCourse')); ?></a>
                      </li>
                  ...
                  <li class="<?php echo e(Nav::isRoute('instructor.settings')); ?> <?php echo e(Nav::isRoute('admin.instructor')); ?> <?php echo e(Nav::isRoute('admin.completed')); ?>">
                    <a href="javaScript:void();">
                      <span><?php echo e(__('InstructorPayout')); ?></span>
                    </a>
                    <ul class="vertical-submenu">

                      <li class="<?php echo e(Nav::isRoute('instructor.settings')); ?>"><a href="<?php echo e(route('instructor.settings')); ?>"><?php echo e(__('PayoutSettings')); ?></a>
                      </li>
                      <li class="<?php echo e(Nav::isRoute('admin.instructor')); ?>"><a href="<?php echo e(route('admin.instructor')); ?>"><?php echo e(__('PendingPayout')); ?></a>
                      </li>
                      <li class="<?php echo e(Nav::isRoute('admin.completed')); ?>"><a href="<?php echo e(route('admin.completed')); ?>"><?php echo e(__('CompletedPayout')); ?></a>
                      </li>
              ...
              <li class="<?php echo e(Nav::isResource('category')); ?> <?php echo e(Nav::isResource('subcategory')); ?> <?php echo e(Nav::isResource('childcategory')); ?> <?php echo e(Nav::isResource('course')); ?> <?php echo e(Nav::isResource('bundle')); ?> <?php echo e(Nav::isResource('courselang')); ?> <?php echo e(Nav::isResource('coursereview')); ?> <?php echo e(Nav::isRoute('assignment.view')); ?> <?php echo e(Nav::isResource('refundpolicy')); ?> <?php echo e(Nav::isResource('batch')); ?> <?php echo e(Nav::isRoute('quiz.review')); ?> <?php echo e(Nav::isResource('private-course')); ?> <?php echo e(Nav::isResource('admin/report/view')); ?> <?php echo e(Nav::isResource('user/question/report')); ?>">
                <a href="javaScript:void();" class="menu"><i class="feather icon-book text-secondary"></i>
                  <span><?php echo e(__('Course')); ?>

                    <div class="sub-menu truncate">Categories, Courses, Bundle Course, Course Language, Course Review,
                      Assignment, Refund Policy, Batch, Quiz Review, Private Course, Reported Course, Reported Question
                    </div>
                  </span>
                  <i class="feather icon-chevron-right"></i>
                </a>
                <ul class="vertical-submenu">
                  ...
                  <li class="<?php echo e(Nav::isResource('category')); ?> <?php echo e(Nav::isResource('subcategory')); ?> <?php echo e(Nav::isResource('childcategory')); ?>">
                    <a href="javaScript:void();"><span><?php echo e(__('Category')); ?></span><i class="feather icon-chevron-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(['categories.view'])): ?>
                      <li class="<?php echo e(Nav::isResource('category')); ?>"><a href="<?php echo e(url('category')); ?>"><?php echo e(__('Category')); ?></a>
                      </li>
                      <?php endif; ?>
                      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(['subcategories.view'])): ?>
                      <li class="<?php echo e(Nav::isResource('subcategory')); ?>"><a href="<?php echo e(url('subcategory')); ?>"><?php echo e(__('SubCategory')); ?></a>
                      </li>
                      <?php endif; ?>
                  ...
                  <li class="<?php echo e(Nav::isResource('course')); ?>"><a href="<?php echo e(url('course')); ?>"><span><?php echo e(__('Courses')); ?></span></a>
                  </li>
                  <?php endif; ?>
                  ...
                  <!-- <li class="<?php echo e(Nav::isResource('bundle')); ?>"><a
                                            href="#"><span><?php echo e(__('BundleCourse')); ?></span></a>
                                    </li> -->
                  <?php endif; ?>
              ...
              <li class="">
                <a href="javaScript:void();">
                  <i class="feather icon-server text-secondary"></i> <span><?php echo e(__('Workshop')); ?></span><i class="feather icon-chevron-right"></i>
                </a>
                <ul class="vertical-submenu">

                  <li><a href="<?php echo e(url('workshop')); ?>"><?php echo e(__('Manage Workshop')); ?></a>
                  </li>
                  <li><a href="<?php echo e(url('all/bookings')); ?>"><?php echo e(__('Workshop Booking')); ?></a>
                  </li>
              ...
              <li class="<?php echo e(Nav::isRoute('googlemeet.setting')); ?> <?php echo e(Nav::isRoute('googlemeet.index')); ?> <?php echo e(Nav::isRoute('googlemeet.allgooglemeeting')); ?>">
                <a href="javaScript:void();">
                  <i class=""></i> <span><?php echo e(__('Google Meet')); ?></span><i class="feather icon-chevron-right"></i>
                </a>
                <ul class="vertical-submenu">

                  <li class="<?php echo e(Nav::isRoute('googlemeet.setting')); ?>"><a href="<?php echo e(route('googlemeet.setting')); ?>"><?php echo e(__('Settings')); ?></a>
                  </li>
                  <li class="<?php echo e(Nav::isRoute('googlemeet.index')); ?>"><a href="<?php echo e(route('googlemeet.index')); ?>"><?php echo e(__('Dashboard')); ?></a>
                  </li>
                  <li class="<?php echo e(Nav::isRoute('googlemeet.allgooglemeeting')); ?>"><a href="<?php echo e(route('googlemeet.allgooglemeeting')); ?>"><?php echo e(__('AllMeetings')); ?></a>
                  </li>
              ...
              <!-- <li class="<?php echo e(Nav::isRoute('certificate.index')); ?>">
                <a href="<?php echo e(route('certificate.index')); ?>" class="menu"><i class="feather icon-help-circle text-secondary"></i>
              ...
              <li class="<?php echo e(Nav::isRoute('onesignal.settings')); ?>">
                <a href="<?php echo e(route('onesignal.settings')); ?>" class="menu">
                  ...
                  <span><?php echo e(__('PushNotification')); ?></span>
                </a>
              </li>
              <?php endif; ?>
              ...
              <!-- <li class="<?php echo e(Nav::isRoute('get.api.key')); ?>">
                                <a href="<?php echo e(route('get.api.key')); ?>" class="menu">
                                    <i class="feather icon-share text-secondary"></i><span><?php echo e(__('GetAPIKeys')); ?></span>
                                </a>
                            </li> -->
              <?php endif; ?>
              ...
              <li class="<?php echo e(Nav::isResource('testimonial')); ?> <?php echo e(Nav::isResource('advertisement')); ?> <?php echo e(Nav::isResource('slider')); ?> <?php echo e(Nav::isResource('facts')); ?> <?php echo e(Nav::isRoute('category.slider')); ?> <?php echo e(Nav::isResource('getstarted')); ?> <?php echo e(Nav::isResource('trusted')); ?> <?php echo e(Nav::isRoute('widget.setting')); ?> <?php echo e(Nav::isRoute('terms')); ?> <?php echo e(Nav::isResource('directory')); ?> <?php echo e(Nav::isRoute('videosetting')); ?> <?php echo e(Nav::isRoute('breadcum')); ?> <?php echo e(Nav::isRoute('fact')); ?> <?php echo e(Nav::isRoute('joininstructor')); ?>">
                <a href="#" class="menu"><i class="feather icon-monitor text-secondary"></i>
                  <span><?php echo e(__('FrontSetting')); ?>

                    <div class="sub-menu truncate"><?php echo e(__('Testimonial, Advertisement, Slider, Fact Slider, Category
                      Slider, Get Started, Trusted Slider, Widget, Seo Directory, Coming Soon, Terms & Condition,
                      Privacy Policy, Invoice Design, Login/Signup, Videosetting, Breadcumsetting, Factsetting, Join an
                      Instructor')); ?></div>
                  </span>
                  <i class="feather icon-chevron-right"></i>
                </a>
              ...
              <li class="<?php echo e(Nav::isResource('slider')); ?>"><a href="<?php echo e(url('slider')); ?>"><span><?php echo e(__('Slider')); ?></span></a>
              </li>
              <?php endif; ?>
              <!--
              ...
              <li class="<?php echo e(Nav::isRoute('gen.set')); ?> <?php echo e(Nav::isRoute('careers.page')); ?>  <?php echo e(Nav::isRoute('termscondition')); ?> <?php echo e(Nav::isRoute('policy')); ?>  <?php echo e(Nav::isRoute('show.pwa')); ?> <?php echo e(Nav::isRoute('adsense')); ?> <?php echo e(Nav::isRoute('ipblock.view')); ?>   <?php echo e(Nav::isRoute('twilio.settings')); ?> <?php echo e(Nav::isRoute('show.sitemap')); ?> <?php echo e(Nav::isRoute('show.lang')); ?>">
                <a href="#" class="menu"><i class="feather icon-settings text-secondary"></i>
                  <span><?php echo e(__('SiteSetting')); ?>

                    <div class="sub-menu truncate"><?php echo e(__('Setting, PWA, Adsense, IP Block Settings, Twilio, Site Map,
                      Language, Email Design')); ?></div>
                  </span>
                  <i class="feather icon-chevron-right"></i>
                </a>
                <!-- <ul class="vertical-submenu">
              ...
              <li class=" <?php echo e(Nav::isRoute('api.setApiView')); ?><?php echo e(Nav::isRoute('bank.transfer')); ?><?php echo e(Nav::isResource('manualpayment')); ?> ">
                <a href="javaScript:void();" class="menu"><i class="feather icon-dollar-sign text-secondary"></i>
                  <span><?php echo e(__('Payment Setting')); ?>

                    <div class="sub-menu truncate">Credentials, MPESA Settings, Bank
                      Deatils, Manual Payment</div>
                  </span>
                  <i class="feather icon-chevron-right"></i>
                </a>
                <ul class="vertical-submenu">
              ...
              <!-- <li class="<?php echo e(Nav::isRoute('player.set')); ?> <?php echo e(Nav::isRoute('ads')); ?> <?php echo e(Nav::isRoute('ad.setting')); ?>">
                                <a href="javaScript:void();" class="menu"><i class="feather icon-play-circle text-secondary"></i>
                                    <span><?php echo e(__('PlayerSettings')); ?><div class="sub-menu truncate">Player Customization, Advertise Settings</div></span>
                                    <i class="feather icon-chevron-right"></i>
                                </a>
                                <ul class="vertical-submenu">
              ...
              <li class="<?php echo e(Nav::isRoute('activity.index')); ?>">
                <a href="<?php echo e(route('activity.index')); ?>" class="menu">
                  <i class="feather icon-help-circle text-secondary"></i><span><?php echo e(__('ActivityLog')); ?></span>
                </a>
              </li>
  ...
  <!-- End Sidebar -->
</div><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views/admin/layouts/new_sidebar.blade.php ENDPATH**/ ?>