...
<div class="page-section riskwala" id="transforming">
    <div class="container wide3">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-5">
                <div class="view-button txt-rgt">
                    <a href="<?php echo e(url('workshop/view')); ?>" class="btn btn-secondary" title="View More"><?php echo e(__('View
                        More')); ?><i data-feather="chevron-right"></i>
                    </a>
                </div>
            </div>
...
<div class="page-section" id="transforming">
    <div class="container wide3">
        ...
        <div class="challenges masonry flex-row item-col-2">
            <div class="item-col full-size">
                <div class="challenge-item">
                    <div class="bg-img" data-bg="images/logo/being-healer.jpg" style="background-image: url(&quot;images/logo/being-healer.jpg&quot;);background-position: center;">
                    </div>
                    <a href="#" class="link"></a>
                    <div class="inner">
                        <h3 class="item-title"><a href="#">Being A Healer</a></h3>
                        <p style="color:#fff" class="limit">Leran and perfect the tools and modalities needed to become
                            an
                            effective Professional Healer.</p>
                        <a href="#" class="item-country">ONLINE + OFFLINE | WHATSAPP</a>
                        <h3 class="item-title"><a href="#">&#x20B9 45,000</a></h3>
                        <div class="butns">
                            <a href="#">Enroll Now</a>
                        </div>
                        <div class="more_btn">
    ...
    <div class="container wide3">
        ...
        <div class="challenges masonry flex-row item-col-2">
            <div class="item-col full-size">
                ...
                <div class="challenge-item">
                    <div class="bg-img" data-bg="images/logo/ad-chakra-therepy.jpg" style="background-image: url(&quot;images/logo/ad-chakra-therepy.jpg&quot;);background-position: center;">
                    </div>
                    <a href="#" class="link"></a>
                    <div class="inner">
                        <h3 class="item-title"><a href="#">Advanced Chakra therapy</a></h3>
                        <p class="limit" style="color:#fff">Go deep into each chakra and learn to leverage its secrets
                            fully.</p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('theme.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/exportica.in/magic.exportica.in/resources/views/home.blade.php ENDPATH**/ ?>