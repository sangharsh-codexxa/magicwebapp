...
<div class="contentbar">
  ...
  <div class="row" style="margin-bottom: 40px">
    <div class="col-lg-4">
      <form class="navbar-form" role="search">
        <div class="input-group ">
          ...
          <a role="button" title="Back" href="<?php echo e(url('course')); ?>" name="clear" value="search" id="clear_id" class="btn btn-warning-rgba btn-xs">
    ...
    <div class="col-md-8 text-right mb-2">
      ...
      <a href="<?php echo e(url('course/create')); ?>" class="btn btn-primary-rgba mr-2"><i class="feather icon-plus mr-2"></i><?php echo e(__('Add Course')); ?></a>

      <?php if(Auth::User()->role == "admin" ): ?>
      <button type="button" class="btn btn-danger-rgba mr-2" data-toggle="modal" data-target="#bulk_delete"><i class="feather icon-trash mr-2"></i> <?php echo e(__('Delete Selected')); ?></button>
      <button type="button" class="btn btn-success-rgba mr-2">
        <div class="select-all-checkbox">

          <div>
            <input id="checkboxAll" type="checkbox" class="filled-in width-15 height-15 t-3 position-relative" name="checked[]" value="all" />
  ...
  <div class="col-lg-4 mb-4">
    <input type='checkbox' form='bulk_delete_form' class='form-card-input check filled-in material-checkbox-input position-absolute width-25 height-25 l-30 t-13' name='checked[]' value="<?php echo e($cat->id); ?>" id='checkbox<?php echo e($cat->id); ?>'>
...
unset($__errorArgs, $__bag); ?> src="<?php echo e(Avatar::create($cat->user->fname)->toBase64()); ?>" alt="profilephoto" class="img-fluid w-h-100" data-toggle="modal" data-target="#exampleStandardModal<?php echo e($cat->user->id); ?>">
      ...
      <div class="card-footer">
        <div class="row mt-3 mb-3">
          ...
          <div class="col-2">
            <a href="<?php echo e(route('user.course.show',['id' => $cat->id, 'slug' => $cat->slug ])); ?>" target="_blank" title="Show">
          ...
          <!--=================== bulk delete end =======================================--->
          <div class="modal fade" id="exampleStandardModal<?php echo e($cat->user->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleStandardModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleStandardModalLabel">
                    <?php echo e($cat->user->fname); ?>
...
unset($__errorArgs, $__bag); ?> src="<?php echo e(url('images/user_img/'.$cat->user->user_img)); ?>" alt="profilephoto" class="img-responsive img-circle">
                            <?php else: ?>
                            <img <?php $__errorArgs = ['photo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?> src="<?php echo e(Avatar::create($cat->user->fname)->toBase64()); ?>" alt="profilephoto" class="img-responsive img-circle">
                            <?php endif; ?>
                          </div>
                          <div class="col-lg-12">
                            ...
                            <div class="button-list mt-4 mb-3">
                              <button type="button" class="btn btn-primary-rgba"><i class="feather icon-email mr-2"></i><?php echo e($cat->user->email); ?></button>
                              <button type="button" class="btn btn-success-rgba"><i class="feather icon-phone mr-2"></i><?php echo e($cat->user->mobile); ?></button>
                            </div>
                            <div class="table-responsive">
                              <table class="table table-borderless mb-0 user-table">
                                <tbody>
                                  ...
                                  <tr>
                                    <th scope="row" class="p-1">
                                      <?php echo e(__('Email ID :')); ?>

                                    </th>
                                    <td class="p-1">
                                      <?php echo e($cat->user->email); ?>
                                  ...
                                  <tr>
                                    ...
                                    <td class="p-1">
                                      <?php echo e(optional($cat->user->country)->name); ?>-<?php echo e(optional($cat->user->state)->name); ?>-<?php echo e(optional($cat->user->city)->name); ?>
                                  ...
                                  <tr>
                                    <th scope="row" class="p-1">
                                      Youtube Url</th>
                                    <td class="p-1">
                                      <a href="<?php echo e($cat->user->youtube_url); ?>"><?php echo e(str_limit($cat->user->youtube_url, '30')); ?></a>
                                    </td>
                                  </tr>
                                  <?php endif; ?>
                                  ...
                                  <tr>
                                    <th scope="row" class="p-1">
                                      Facebook Url</th>
                                    <td class="p-1">
                                      <a href="<?php echo e($cat->user->fb_url); ?>"><?php echo e(str_limit($cat->user->fb_url, '30')); ?></a>
                                    </td>
                                  </tr>
                                  <?php endif; ?>
                                  ...
                                  <tr>
                                    <th scope="row" class="p-1">
                                      Twitter URL</th>
                                    <td class="p-1">
                                      <a href="<?php echo e($cat->user->twitter_url); ?>"><?php echo e(str_limit($cat->user->twitter_url, '30')); ?></a>
                                    </td>
                                  </tr>
                                  <?php endif; ?>
                                  ...
                                  <tr>
                                    <th scope="row" class="p-1">
                                      Linkedin URL</th>
                                    <td class="p-1">
                                      <a href="<?php echo e($cat->user->linkedin_url); ?>"><?php echo e(str_limit($cat->user->linkedin_url, '30')); ?></a>
                                    </td>
                                    </td>
                                  </tr>
                                  <?php endif; ?>
          ...
          <div class="col-2 duplicate">
            ...
            <a href="<?php echo e(route('course.duplicate',$cat->id)); ?>" title="Duplicate">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views\admin\course\partial\index.blade.php ENDPATH**/ ?>