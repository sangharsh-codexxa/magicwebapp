                  ...
                  <div class="form-row">
                     ...
                     <div class="col-md-12">
                        <table class="table table-bordered table-striped">
                          ...
                          <tbody>
                             ...
                             <tr>
                                <?php
                                  $v = phpversion();
                                ?>
                              <td>php version (<b><?php echo e($v); ?></b>)</td>
                              <td>
                          ...
                          <tr>
                            <td><b><?php echo e(storage_path()); ?></b> is writable?</td>
                            <td>
                              <?php
                                $path = storage_path();
                              ?>
                          ...
                          <tr>
                            <td><b><?php echo e(base_path('bootstrap/cache')); ?></b> is writable?</td>
                            <td>
                              <?php
...
<?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views\install\servercheck.blade.php ENDPATH**/ ?>