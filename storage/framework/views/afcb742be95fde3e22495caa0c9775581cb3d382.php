...
<div class="col-md-4 col-lg-4">
  ...
  <button type="button" class="float-right btn btn-danger-rgba mr-2" data-toggle="modal" data-target="#bulk_delete"><i
    ...
    <a href="<?php echo e(url('faqinstructor/create')); ?>" class="float-right btn btn-primary-rgba mr-2"><i class="feather icon-plus mr-2"></i><?php echo e(__('Add FAQ')); ?></a>
            <?php endif; ?>
  </div>
</div>
<?php $__env->endSlot(); ?>
    ...
    <div class="col-lg-12">
        ...
        <div class="card m-b-30">
                ...
                <div class="card-header">
                    <h5 class="card-box"><?php echo e(__('All FAQ Instructor')); ?></h5>
                </div> 
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                            ...
                                            <a class="dropdown-item" href="<?php echo e(url('faqinstructor/'.$p->id.'/edit')); ?>"><i class="feather icon-edit mr-2"></i><?php echo e(__('Edit')); ?></a>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('faq.faq-instructor.delete')): ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views\admin\faq_instructor\index.blade.php ENDPATH**/ ?>