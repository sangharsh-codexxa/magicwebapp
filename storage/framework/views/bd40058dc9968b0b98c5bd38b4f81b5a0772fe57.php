      ...
      <div class="preL display-none">
        <div class="preloader3 display-none"></div>
          ...
          <div class="card-header">
            ...
            <form autocomplete="off" action="<?php echo e(route('store.step2')); ?>" id="step2form" method="POST" class="database-validation" novalidate>
              <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views\install\step2.blade.php ENDPATH**/ ?>