...
<html lang="en">
  ...
  <body>
        ...
        <div class="preloader3 display-none"></div>
          ...
          <div class="card-header">
              <h3 class="m-3 text-center text-dark ">
               ...
               <form autocomplete="off" enctype="multipart/form-data" action="<?php echo e(route('store.step4')); ?>" id="step4form" method="POST" class="needs-validation" novalidate>
                  <?php echo csrf_field(); ?>
                   <h3>Create Admin</h3>
                   <hr>
                  <div class="form-row">
    ...
    <script>
      ...
      $(function() {
        var urlLike = '<?php echo e(url('allcountry/dropdown')); ?>';
      ...
      $(function() {
        var urlLike = '<?php echo e(url('allcountry/gcity')); ?>';
...
</html><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views\install\step4.blade.php ENDPATH**/ ?>