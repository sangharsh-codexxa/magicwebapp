...
<section id="wishlist-home" class="wishlist-home-main-block">
    <div class="container-xl">
        <h1 class="wishlist-home-heading text-white"><?php echo e(__('Checkout')); ?></h1>
    </div>
</section> 
<!-- about-home end -->
			            		...
			            		<div class="col-lg-9 col-8">
			            			<ul>
		                                ...
		                                <?php if($cart->offer_price == !NULL): ?>
			            					...
			            					<li class="checkout-course-price"><b><?php echo e(currency($cart->offer_price, $from = $currency->code, $to = $currency->code, $format = true)); ?></b>  <s><?php echo e(currency($cart->price, $from = $currency->code, $to = $currency->code, $format = true)); ?></s></li>
	            ...
	            <div class="col-lg-8 col-sm-8">
	            	<div class="checkout-pricelist">
		            	<ul>
		            		...
		            		<li><h1 class="checkout-total"><?php echo e(__('Total')); ?>: <?php echo e(currency($cart_total, $from = $currency->code, $to = $currency->code, $format = true)); ?></h1></li>
		                            	...
		                            	<div class="payment-proceed-btn">
											...
											<div class="card">
											  ...
											  <ul class="list-group list-group-flush">
											    ...
											    <li class="list-group-item"><b><?php echo e(__('Bank Acccount Number')); ?>:</b>&nbsp;<?php echo e($bankdetail['account_number']); ?></li>
												...
												<div class="row">
											        ...
											        <div class="col-md-12">
											            <div class="form-group">
											                ...
											                <small class="text-muted"><i class="fa fa-question-circle"></i><?php echo e(__('TCKN for Turkish merchants, passport number for foreign merchants')); ?></small>
											            </div>
											        </div>
											    </div>
...
<?php echo $__env->make('theme.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views\checkout.blade.php ENDPATH**/ ?>