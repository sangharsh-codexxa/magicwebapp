                      ...
                      <div class="invoice-billing">
                          <div class="row">
                              ...
                              <div class="col-sm-6 col-md-4 col-lg-4">
                                  ...
                                  <?php endif; ?>
                                      ...
                                      <ul class="list-unstyled">
                                          ...
                                          <li><?php echo e(__('Address')); ?>: <?php echo e($show->user['address']); ?><br>
                              ...
                              <div class="col-sm-12 col-md-4 col-lg-4 mt-3">
                                ...
                                <b><?php echo e(__('OrderID')); ?>:</b> <?php echo e($show['order_id']); ?><br>
                                <b><?php echo e(__('TransactionId')); ?>:</b>&nbsp;<?php echo e($show['transaction_id']); ?><br>
                                <b><?php echo e(__('aymentMethod')); ?>:</b>&nbsp;<?php echo e($show['payment_method']); ?><br>
                                ...
                                <b><?php echo e(__('Enrollon')); ?>:</b> <?php echo e(date('jS F Y', strtotime($show['created_at']))); ?></br>
                                <b>
                                  <?php if($show->enroll_expire != NULL): ?>
                                    <?php echo e(__('EnrollEnd')); ?>:</b> <?php echo e(date('jS F Y', strtotime($show['enroll_expire']))); ?></br>
                                  <?php endif; ?>
                                  <br>
          
                                  <?php if($show->proof != NULL): ?>
                                     <a href="<?php echo e(asset('images/order/'.$show->proof)); ?>" download="<?php echo e($show->proof); ?>" title="Course"><?php echo e(__('Download Proof')); ?> <i class="fa fa-download"></i></a></br>
                                  <?php endif; ?>
                              ...
                              <table class="table table-borderless">
                                  <thead>
                                      <tr>
                                        ...
                                        <th><?php echo e(__('CouponDiscount')); ?></th>
                                        <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views\admin\order\view.blade.php ENDPATH**/ ?>