...
<div class="col-md-4 col-lg-4">
  <a href="<?php echo e(route('allinstructor.index')); ?>" class="float-right btn btn-primary-rgba mr-2"><i
    ...
    <div class="col-lg-12">
      <div class="card m-b-30">
        <div class="card-header">
          <h5 class="box-title"><?php echo e(__('Edit')); ?> <?php echo e(__('Instructor')); ?></h5>
        </div>
        <div class="card-body ml-2">
          <form action="<?php echo e(route('allinstructor.update',$user->id)); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <textarea name="address" class="form-control" rows="1"
                    placeholder="<?php echo e(__('Please')); ?> <?php echo e(__('Enter')); ?> adderss" value=""><?php echo e($user->address); ?></textarea>
                </div>
                ...
                <div class="form-group" >
                  ...
                  <input type="password" name="confirmpassword" class="form-control"
                    placeholder="<?php echo e(__('Please')); ?> <?php echo e(__('ConfirmPassword')); ?>">
                </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="role"><?php echo e(__('SelectRole')); ?>:</label>
                  <?php if(Auth::User()->role=="admin"): ?>
                  <select class="form-control select2" name="role">
                    <option <?php echo e($user->role == 'instructor' ? 'selected' : ''); ?> value="instructor"><?php echo e(__('Instructor')); ?>
                ...
                <div class="form-group">
                  ...
                  <input value="<?php echo e($user->pin_code); ?>"
                    placeholder="<?php echo e(__('Please')); ?> <?php echo e(__('Enter')); ?> <?php echo e(__('Pincode')); ?>" type="text"
                    name="pin_code" class="form-control">
                </div>
           
                <div class="form-group">
                  <label><?php echo e(__('Preview Image')); ?>:<sup class="redstar">*</sup></label>
                  <small class="text-muted"><i class="fa fa-question-circle"></i>
                    <?php echo e(__('Recommendedsize')); ?> (1375 x 409px)</small>
               ...
               <div class="form-group">
                  ...
                  <textarea id="detail" name="detail" class="form-control" rows="5"
                    placeholder="<?php echo e(__('Please')); ?> <?php echo e(__('Enter')); ?> <?php echo e(__('Detail')); ?>"
            ...
            <div class="col-md-6">
              <div class="form-group">
                  <label for="exampleInputDetails"><?php echo e(__('Verified')); ?>:<sup
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\magic\magic.exportica.in\resources\views\admin\allinstructor\edit.blade.php ENDPATH**/ ?>