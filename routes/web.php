...
Route::get('/rada', function () {
    ...
    Alert::success('CaRun !')->persistent('Close')->autoclose(6000);
});
...
Route::middleware(['web'])->group(function () {
    ...
    Route::middleware(['IsInstalled', 'switch_languages', 'ip_block'])->group(function () {
        ...
        if (env('DEFAULT_THEME') == 'classic') {
            ...
            Route::middleware(['is_verified', 'maintanance_mode'])->group(function () {
                ...
                // Route::get('/', 'HomeController@index');
                // Route::get('/', 'AlluserController@login');
        ...
        Route::middleware(['admin_instructor', 'IsInstalled', 'auth'])->group(function () {
            ...
            Route::post('/workshop/store', 'WorkshopController@store')->name('workshop.store');
    ...
    Route::get('mybooking', 'OrderController@bookings')->name('mybooking.show');
    Route::get('all/bookings', 'WorkshopController@bookings');
    Route::get('list/bookings', 'WorkshopController@list');
    ...
    Route::middleware(['is_verified', '2fa', 'maintanance_mode', 'switch_languages'])->group(function () {
        ...
        if (env('DEFAULT_THEME') == 'classic') {
            ...
            Route::post('book-workshop', 'WorkshopController@book')->name('book-workshop');
        ...
        Route::get('workshopsdata/view', 'ViewmoreController@workshopsdata')->name('workshopsdata.view');
        Route::get('shortcourse/view', 'ViewmoreController@shortcourse')->name('shortcourse.view');
        Route::get('longcourse/view', 'ViewmoreController@longcourse')->name('longcourse.view');
        ...
        Route::get('workshop/{id}/details', 'WorkshopController@workshopDetail');
        Route::get('longcourse/{id}/{slug}', 'CourseController@CourseDetailPage')->name('user.course.show');
        Route::get('shortcourse/{id}/{slug}', 'CourseController@CourseDetailPage')->name('user.course.show');

        Route::get('answersheet/{id}', 'QuizTopicController@delete')->name('answersheet');
        //Workshop
        Route::get('admin/workshop', 'WorkshopController@index')->name('workshop.view');
