                    ...
                    <div class="container-xl">
                        ...
                        @if($course->user['user_img'] !== NULL && $course->user['user_img'] !== '')
                            ...
                            <img src="{{ asset('images/default/user.png') }}" class="img-fluid" alt="">
                                @endif
                                <h3 class="about-content-heading">{{ optional($course->user)['fname'] }} {{ optional($course->user)['lname'] }}</h3>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <a style="box-shadow:0 3px 6px 0 rgb(42 106 255 / 30%)" href="{{ route('instructor.profile', ['id' => $course->user->id, 'name' => $fullname] ) }}" class="btn btn-primary" title="course">{{ __('Profile')}}</a>
                            </div>
            ...
            <div class="col-lg-8 col-md-8" >
                @if($whatlearns->isNotEmpty())
                    <div class="product-learn-block" >
                        <h3 class="product-learn-heading" style="color:#fff;">{{ __('Whatlearn') }}</h3>
                        <div class="row">
                ...
                <div class="course-content-block btm-30 top-20" >
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-8">
                            <h3 class="course-content">{{ __('CourseContent') }}</h3>
                        </div>
                        <!--
