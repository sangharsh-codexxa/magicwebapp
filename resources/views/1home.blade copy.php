             ...
             <div class="item">
                <div class="instructor-home-block text-center">
                    <div class="instructor-home-block-one">
                        ...
                        @else
                        <a href="#" title=""><img src="{{ Avatar::create($inst->user->fname)->toBase64() }}" alt="course"
                            class="img-fluid"></a>
                        @endif
...
<!-- categories end -->
<!-- testimonial start -->
@if($hsetting->testimonial_enable == 9 && ! $testi->isEmpty() )
    ...
    <div class="container-fluid p-0">
        <div class="get-started-block">
            <div class="get-started-bg-image">
                ...
                @else
                <img src="{{ Avatar::create($get_enable->heading)->toBase64() }}" alt="course"
                    class="img-fluid">
                @endif                
                <div class="overlay-bg"></div>
            </div>
