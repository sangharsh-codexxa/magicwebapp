                        ...
                        <ul class="vertical-menu">
                            ...
                            <li
                                ...
                                <ul class="vertical-submenu">
                                    ...
                                    <li
                                        ...
                                        <a href="javaScript:void();">
                                            <i class=""></i> <span>{{ __('InstructorPayout') }}</span>
                                        </a>
                                        <ul class="vertical-submenu">

                                            <li class="{{ Nav::isRoute('instructor.settings') }}"><a
                                                    href="{{route('instructor.settings')}}">{{ __('PayoutSettings') }}</a>
                                            </li>
                                            <li class="{{ Nav::isRoute('admin.instructor') }}"><a
                                                    href="{{route('admin.instructor')}}">{{ __('PendingPayout') }}</a>
                                            </li>
                            ...
                            <li
                                ...
                                <ul class="vertical-submenu">
                                    ...
                                    <li class="{{ Nav::isResource('bundle') }}"><a
                                            href="{{url('bundle')}}"><span>{{ __('BundleCourse') }}</span></a>
                                    </li>
                                    @endcan
                            ...
                            <li class="{{ Nav::isRoute('onesignal.settings') }}"><a
                                    href="{{route('onesignal.settings')}}"><i
                                        class="feather icon-navigation text-secondary"></i><span>{{ __('PushNotification') }}</span></a>
                            </li>
                            @endcan
                            ...
                            <li
                                ...
                                <a href="javaScript:void();">
                                    <i
                                        class="feather icon-monitor text-secondary"></i><span>{{ __('FrontSetting') }}</span><i
                                        class="feather icon-chevron-right"></i>
                                </a>
                                <ul class="vertical-submenu">
                            ...
                            <li
                                ...
                                <a href="javaScript:void();">
                                    <i
                                        class="feather icon-settings text-secondary"></i><span>{{ __('SiteSetting') }}</span><i
                                        class="feather icon-chevron-right"></i>
                                </a>
                                <ul class="vertical-submenu">
                            ...
                            <li
                                ...
                                <a href="javaScript:void();">
                                    <i
                                        class="feather icon-play-circle text-secondary"></i><span>{{ __('PlayerSettings') }}</span><i
                                        class="feather icon-chevron-right"></i>
                                </a>
                                <ul class="vertical-submenu">
