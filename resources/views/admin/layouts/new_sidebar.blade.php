            ...
            <ul class="vertical-menu">
              ...
              <li class="{{ Nav::isRoute('user.index') }} {{ Nav::isRoute('user.add') }} {{ Nav::isRoute('user.edit') }}{{ Nav::isRoute('alluser.index') }} {{ Nav::isRoute('alluser.add') }} {{ Nav::isRoute('alluser.edit') }}{{ Nav::isRoute('allinstructor.index') }} {{ Nav::isRoute('allinstructor.add') }} {{ Nav::isRoute('allinstructor.edit') }}{{ Nav::isResource('roles') }}">
                <a href="javaScript:void();" class="menu"><i class="feather icon-users text-secondary"></i>
                  <span>{{ __('Users') }}
                    <div class="sub-menu truncate">{{__('All Users, All Students, All Instructors, Roles And
                      Permission')}}</div>
                  </span>
                ...
                <ul class="vertical-submenu">
                  ...
                  @can('Alluser.view')
                  <li>
                    <a class="{{ Nav::isResource('allusers') }}" href="{{route('allusers.index')}}">{{ __('All
                      Students') }}</a>
                  </li>
                  @endcan
                  @can('Allinstructor.view')
                  <li>
                    <a class="{{ Nav::isResource('allinstructor') }}" href="{{route('allinstructor.index')}}">{{ __('All
                      Instructors') }}</a>
                  </li>
                  @endcan
                  <li>
                    <a class="{{ Nav::isResource('alladmin') }}" href="{{route('alladmin.index')}}">{{ __('All Admins')
                      }}</a>
                  </li>
                  <li>
                    <a class="{{ Nav::isResource('alladmin') }}" href="{{route('user.verify')}}">{{ __('Verify User')
                      }}</a>
                  </li>
                  <li>
                    <a class="{{ Nav::isResource('roles') }}" href="{{route('roles.index')}}">{{ __('Roles And
                      Permission') }}</a>
                  </li>
              ...
              <li style="display:none" class="{{ Nav::isResource('plan/subscribe/settings') }} {{ Nav::isResource('subscription/plan') }}  {{ Nav::isRoute('all.instructor') }} {{ Nav::isResource('requestinstructor') }}">
                <a href="javaScript:void();" class="menu"><i class="feather icon-user text-secondary"></i>
                  <span>{{ __('Instructors') }}
                    <div class="sub-menu truncate">{{__('All Instructor Request, Pending Request, Instructor
                ...
                <ul class="vertical-submenu">
                  ...
                  <li class="{{ Nav::isResource('requestinstructor') }}"><a href="{{url('requestinstructor')}}">{{
                      __('Pending') }}
                      {{ __('Request') }}</a></li>
                  @endcan
                  @can('instructor-plan-subscription.view')
                  <li class="{{ Nav::isResource('plan/subscribe/settings') }}"><a href="{{url('plan/subscribe/settings')}}">{{ __('Instructor') }}
                      {{ __('Subscription') }}</a></li>
                  @endcan
                  @if(env('ENABLE_INSTRUCTOR_SUBS_SYSTEM') == 1)
                  <li class="{{ Nav::isResource('subscription/plan') }}"><a href="{{url('subscription/plan')}}">{{
                      __('InstructorPlan') }}</a>
                  </li>
                  @endif
                  ...
                  <li class="{{ Nav::isRoute('allrequestinvolve') }} {{ Nav::isRoute('involve.request.index') }} {{ Nav::isRoute('involve.request') }}">
                    <a href="javaScript:void();">
                      <span>{{ __('MultipleInstructor') }}</span>
                    </a>
                    <ul class="vertical-submenu">

                      <li class="{{ Nav::isRoute('allrequestinvolve') }}"><a href="{{route('allrequestinvolve')}}">{{
                          __('RequesttoInvolve') }}</a>
                      </li>
                      <li class="{{ Nav::isRoute('involve.request.index') }}"><a href="{{route('involve.request.index')}}">{{ __('InvolvementRequests') }}</a>
                      </li>
                      <li class="{{ Nav::isRoute('involve.request') }}"><a href="{{route('involve.request')}}">{{
                          __('InvolvedInCourse') }}</a>
                      </li>
                  ...
                  <li class="{{ Nav::isRoute('instructor.settings') }} {{ Nav::isRoute('admin.instructor') }} {{ Nav::isRoute('admin.completed') }}">
                    <a href="javaScript:void();">
                      <span>{{ __('InstructorPayout') }}</span>
                    </a>
                    <ul class="vertical-submenu">

                      <li class="{{ Nav::isRoute('instructor.settings') }}"><a href="{{route('instructor.settings')}}">{{ __('PayoutSettings') }}</a>
                      </li>
                      <li class="{{ Nav::isRoute('admin.instructor') }}"><a href="{{route('admin.instructor')}}">{{
                          __('PendingPayout') }}</a>
                      </li>
                      <li class="{{ Nav::isRoute('admin.completed') }}"><a href="{{route('admin.completed')}}">{{
                          __('CompletedPayout') }}</a>
                      </li>
              ...
              <li class="{{ Nav::isResource('category') }} {{ Nav::isResource('subcategory') }} {{ Nav::isResource('childcategory') }} {{ Nav::isResource('course') }} {{ Nav::isResource('bundle') }} {{ Nav::isResource('courselang') }} {{ Nav::isResource('coursereview') }} {{ Nav::isRoute('assignment.view') }} {{ Nav::isResource('refundpolicy') }} {{ Nav::isResource('batch') }} {{ Nav::isRoute('quiz.review') }} {{ Nav::isResource('private-course') }} {{ Nav::isResource('admin/report/view') }} {{ Nav::isResource('user/question/report') }}">
                ...
                <ul class="vertical-submenu">
                  ...
                  <li class="{{ Nav::isResource('category') }} {{ Nav::isResource('subcategory') }} {{ Nav::isResource('childcategory') }}">
                    <a href="javaScript:void();"><span>{{ __('Category') }}</span><i class="feather icon-chevron-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                      @can(['categories.view'])
                      <li class="{{ Nav::isResource('category') }}"><a href="{{url('category')}}">{{ __('Category')
                          }}</a>
                      </li>
                      @endcan
                      @can(['subcategories.view'])
                      <li class="{{ Nav::isResource('subcategory') }}"><a href="{{url('subcategory')}}">{{
                          __('SubCategory') }}</a>
                      </li>
                      @endcan
                  ...
                  <!-- Category end  -->
                  @can(['courses.view'])
                  <li class="{{ Nav::isResource('course') }}"><a href="{{url('course')}}"><span>{{ __('Courses')
                        }}</span></a>
                  </li>
                  @endcan
                  @can(['orders.manage'])
                  ...
                  <!-- <li class="{{ Nav::isResource('bundle') }}"><a
                                            href="#"><span>{{ __('BundleCourse') }}</span></a>
                                    </li> -->
                  @endcan
                  @can(['course-languages.view'])
                  <!-- <li class="{{ Nav::isResource('courselang') }}"><a
                                            href="{{url('courselang')}}"><span>{{ __('CourseLanguage') }}</span></a>
                                    </li> -->
                  @endcan
                  @can(['course-reviews.view'])
                  <!-- <li class="{{ Nav::isResource('coursereview') }}"><a
                                            href="{{url('coursereview')}}"><span>{{ __('CourseReview') }}</span></a>
                                    </li> -->
                  @endcan
                  @can(['assignment.view'])
                  ...
                  <!-- <li class="{{ Nav::isResource('refundpolicy') }}"><a
                                            href="{{url('refundpolicy')}}"><span>{{ __('RefundPolicy') }}</span></a>
                                    </li> -->
                  @endcan
                  @can(['batch.view'])
                  ...
                  <!-- <li class="{{ Nav::isResource('private-course') }}"><a
                                            href="{{url('private-course')}}"><span>{{ __('PrivateCourse') }}</span></a>
                                    </li> -->
                  @endcan
              ...
              <li class="">
                <a href="javaScript:void();">
                  <i class="feather icon-server text-secondary"></i> <span>{{ __('Workshop') }}</span><i class="feather icon-chevron-right"></i>
                </a>
                <ul class="vertical-submenu">

                  <li><a href="{{url('workshop')}}">{{ __('Manage Workshop') }}</a>
                  </li>
                  <li><a href="{{url('all/bookings')}}">{{ __('Workshop Booking') }}</a>
                  </li>
              ...
              <li class="{{ Nav::isRoute('googlemeet.setting') }} {{ Nav::isRoute('googlemeet.index') }} {{ Nav::isRoute('googlemeet.allgooglemeeting') }}">
                ...
                <ul class="vertical-submenu">
                  ...
                  <li class="{{ Nav::isRoute('googlemeet.setting') }}"><a href="{{route('googlemeet.setting')}}">{{
                      __('Settings') }}</a>
                  </li>
                  <li class="{{ Nav::isRoute('googlemeet.index') }}"><a href="{{route('googlemeet.index')}}">{{
                      __('Dashboard') }}</a>
                  </li>
                  <li class="{{ Nav::isRoute('googlemeet.allgooglemeeting') }}"><a href="{{route('googlemeet.allgooglemeeting')}}">{{ __('AllMeetings') }}</a>
                  </li>
              ...
              <!-- <li
                                        ...
                                        <ul class="vertical-submenu">
                                            ...
                                            <li class="{{ Nav::isRoute('admin.revenue.report') }}">
                                                <a
                                                    href="{{route('admin.revenue.report')}}">{{ __('AdminRevenue') }}</a>
                                            </li>

                                            <li class="{{ Nav::isRoute('instructor.revenue.report') }}">
                                                <a
                                                    href="{{route('instructor.revenue.report')}}">{{ __('InstructorRevenue') }}</a>
                                            </li>
              ...
              <!-- <li class="{{ Nav::isResource('faq') }} {{ Nav::isResource('faqinstructor') }}">
                                ...
                                <ul class="vertical-submenu">
                                    ...
                                    <li class="{{ Nav::isResource('faqinstructor') }}">
                                        <a href="{{url('faqinstructor')}}">{{ __('FaqInstructor') }}</a>
                                    </li>
              ...
              <li class="{{ Nav::isResource('testimonial') }} {{ Nav::isResource('advertisement') }} {{ Nav::isResource('slider') }} {{ Nav::isResource('facts') }} {{ Nav::isRoute('category.slider') }} {{ Nav::isResource('getstarted') }} {{ Nav::isResource('trusted') }} {{ Nav::isRoute('widget.setting') }} {{ Nav::isRoute('terms') }} {{ Nav::isResource('directory') }} {{ Nav::isRoute('videosetting') }} {{ Nav::isRoute('breadcum') }} {{ Nav::isRoute('fact') }} {{ Nav::isRoute('joininstructor') }}">
                <a href="#" class="menu"><i class="feather icon-monitor text-secondary"></i>
                  <span>{{ __('FrontSetting') }}
                    <div class="sub-menu truncate">{{__('Testimonial, Advertisement, Slider, Fact Slider, Category
              ...
              <li class="{{ Nav::isResource('slider') }}"><a href="{{url('slider')}}"><span>{{ __('Slider')
                    }}</span></a>
              </li>
              @endcan
              <!--
                                    ...
                                    <li class="{{ Nav::isRoute('category.slider') }}"><a
                                            href="{{route('category.slider')}}"><span>{{ __('CategorySlider') }}</span></a>
                                    </li>
                                    @endcan
                                    <!--
                                    ...
                                    <li class="{{ Nav::isResource('getstarted') }}"><a
                                            href="{{url('getstarted')}}">{{ __('GetStarted') }}</a>
                                    </li>
                                    @endcan
                                    @can(['front-settings.trusted-sliders.view'])
                                    <li class="{{ Nav::isResource('trusted') }}"><a
                                            href="{{url('trusted')}}"><span>{{ __('TrustedSlider') }}</span></a>
                                    </li>
                                    @endcan
                                    @can(['widget.manage'])
                                    ...
                                    <li class="{{ Nav::isRoute('comingsoon.page') }}">
                                        <a
                                            href="{{route('comingsoon.page')}}">{{ __('ComingSoon') }}</a>
                                    </li>
                                    @endcan
                                    ...
                                    <li class="{{ Nav::isRoute('policy') }}">
                                        <a href="{{route('policy')}}">{{ __('PrivacyPolicy') }}</a>
                                    </li>
                                    @endcan
              ...
              <li class="{{ Nav::isRoute('gen.set') }} {{ Nav::isRoute('careers.page') }}  {{ Nav::isRoute('termscondition') }} {{ Nav::isRoute('policy') }}  {{ Nav::isRoute('show.pwa') }} {{ Nav::isRoute('adsense') }} {{ Nav::isRoute('ipblock.view') }}   {{ Nav::isRoute('twilio.settings') }} {{ Nav::isRoute('show.sitemap') }} {{ Nav::isRoute('show.lang') }}">
                <a href="#" class="menu"><i class="feather icon-settings text-secondary"></i>
                  <span>{{ __('SiteSetting') }}
                    <div class="sub-menu truncate">{{__('Setting, PWA, Adsense, IP Block Settings, Twilio, Site Map,
                ...
                <!-- <ul class="vertical-submenu">
                                    ...
                                    <li class="{{ Nav::isRoute('ipblock.view') }}">
                                        <a
                                            href="{{url('admin/ipblock')}}">{{ __('IPBlockSettings') }}</a>
                                    </li>
                                    @endif
              ...
              <li class=" {{ Nav::isRoute('api.setApiView') }}{{ Nav::isRoute('bank.transfer') }}{{ Nav::isResource('manualpayment') }} ">
                ...
                <ul class="vertical-submenu">
                  ...
                  <li class="{{ Nav::isRoute('bank.transfer') }}">
                    <a href="{{route('bank.transfer')}}">{{ __('BankDetails') }}</a>
                  </li>
                  @endcan
              ...
              <!-- <li class="{{ Nav::isRoute('player.set') }} {{ Nav::isRoute('ads') }} {{ Nav::isRoute('ad.setting') }}">
                                <a href="javaScript:void();" class="menu"><i class="feather icon-play-circle text-secondary"></i>
                                    <span>{{ __('PlayerSettings') }}<div class="sub-menu truncate">Player Customization, Advertise Settings</div></span>
                                    <i class="feather icon-chevron-right"></i>
                                </a>
                                <ul class="vertical-submenu">
                                    ...
                                    <li class="{{ Nav::isRoute('player.set') }}"><a
                                            href="{{route('player.set')}}">{{ __('PlayerCustomization') }}</a>
                                    </li>
                                    @endcan
