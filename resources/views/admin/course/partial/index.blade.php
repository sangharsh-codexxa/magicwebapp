...
<div class="contentbar">
  ...
  <div class="row" style="margin-bottom: 40px">
    <div class="col-lg-4">
      <form class="navbar-form" role="search">
        <div class="input-group ">
          ...
          <a role="button" title="Back" href="{{ url('course') }}" name="clear" value="search" id="clear_id" class="btn btn-warning-rgba btn-xs">
            {{ __('Clear Search') }}
          </a>
          @endif
    ...
    <div class="col-md-8 text-right mb-2">
      ...
      <a href="{{url('course/create')}}" class="btn btn-primary-rgba mr-2"><i class="feather icon-plus mr-2"></i>{{ __('Add Course') }}</a>

      @if(Auth::User()->role == "admin" )
      <button type="button" class="btn btn-danger-rgba mr-2" data-toggle="modal" data-target="#bulk_delete"><i class="feather icon-trash mr-2"></i> {{ __('Delete Selected') }}</button>
  ...
  <div class="col-lg-4 mb-4">
    <input type='checkbox' form='bulk_delete_form' class='form-card-input check filled-in material-checkbox-input position-absolute width-25 height-25 l-30 t-13' name='checked[]' value="{{ $cat->id }}" id='checkbox{{ $cat->id }}'>
    ...
    <div class="card partial-course-img">
      ...
      <div class="card-footer">
        <div class="row mt-3 mb-3">
          ...
          <div class="col-2">
            <a href="{{ route('user.course.show',['id' => $cat->id, 'slug' => $cat->slug ]) }}" target="_blank" title="Show">
          ...
          <!--=================== bulk delete end =======================================--->
          <div class="modal fade" id="exampleStandardModal{{$cat->user->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleStandardModalLabel" aria-hidden="true">
                      ...
                      <div class="card-body py-5">
                        <div class="row">
                          <div class="user-modal">
                            ...
                            <img @error('photo') is-invalid @enderror src="{{ url('images/user_img/'.$cat->user->user_img) }}" alt="profilephoto" class="img-responsive img-circle">
                            @else
                            <img @error('photo') is-invalid @enderror src="{{ Avatar::create($cat->user->fname)->toBase64() }}" alt="profilephoto" class="img-responsive img-circle">
                            @endif
                          </div>
                          <div class="col-lg-12">
                            ...
                            <div class="button-list mt-4 mb-3">
                              <button type="button" class="btn btn-primary-rgba"><i class="feather icon-email mr-2"></i>{{ $cat->user->email }}</button>
                              <button type="button" class="btn btn-success-rgba"><i class="feather icon-phone mr-2"></i>{{ $cat->user->mobile }}</button>
                            </div>
          ...
          <div class="col-2 duplicate">
            ...
            <a href="{{ route('course.duplicate',$cat->id) }}" title="Duplicate">
