      ...
      <div class="card m-b-30">
        ...
        <div class="card-body">
          ...
          <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            ...
            <a class="nav-link mb-2" id="v-pills-notifications-tab" style="display:none;" data-toggle="pill" href="#v-pills-notifications" role="tab" aria-controls="v-pills-notifications" aria-selected="false"><i class="feather icon-bell mr-2"></i>{{ __('Question') }}</a>

            <a class="nav-link mb-2" id="v-pills-profile-tab" style="display:none;" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false"><i class="feather icon-user mr-2"></i>{{ __('ReviewRating') }}</a>

            <a class="nav-link  mb-2" id="v-pills-logout-tab" style="display:none;" data-toggle="pill" href="#v-pills-logout" role="tab" aria-controls="v-pills-logout" aria-selected="false"><i class="feather icon-speaker mr-2"></i>{{ __('Announcement') }}</a>

            <a class="nav-link  mb-2" id="v-pills-ReviewReport-tab" style="display:none;" data-toggle="pill" href="#v-pills-ReviewReport" role="tab" aria-controls="v-pills-ReviewReport" aria-selected="false"><i class="feather icon-file-text mr-2"></i>{{ __('ReviewReport') }}</a>
            ...
            <a class="nav-link" id="v-pills-PreviousPaper-tab4" data-toggle="pill" href="#v-pills-PreviousPaper" style="display:none;" role="tab" aria-controls="v-pills-PreviousPaper" aria-selected="false"><i class="feather icon-file mr-2"></i>{{ __('PreviousPaper') }}</a>
            @endif
