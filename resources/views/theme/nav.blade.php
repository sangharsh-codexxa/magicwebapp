            ...
            <div id="mySidenav" class="sidenav">
                ...
                <div class="sidebar-nav-icon">
                    <ul>
                        ...
                        <a href="{{ route('mybooking.show') }}">
                            <li><i data-feather="book-open"></i>{{ __('My Workshop Bookings') }}</li>
                        </a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-1">
                                    <div class="Login-btn" style="display:flex">
                                        <a href="{{ route('login') }}" class="btn btn-secondary" title="login">{{ __('Login') }}</a>
                                        <a style="margin-left:10px;border-radius:20px" href="{{ route('register') }}" class="btn btn-primary" title="register">{{ __('btn2') }}</a>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right User-Dropdown U-open" aria-labelledby="dropdownMenu1">
                                                    ...
                                                    <div class="scroll-down">
                                                        ...
                                                        <a style="display:none;" target="_blank" href="{{ url('/admins') }}">
                                                            <li><i data-feather="pie-chart"></i>{{ __('AdminDashboard') }}</li>
                                                        </a>
                                                        ...
                                                        <a style="display:none;" target="_blank" href="{{ url('/instructor') }}">
                                                            <li><i data-feather="pie-chart"></i>{{ __('InstructorDashboard') }}</li>
                                                        </a>
                                                        @endif
                                                        ...
                                                        <a href="{{ route('mybooking.show') }}">
                                                            <li><i data-feather="book-open"></i>{{ __('My Workshop Booking') }}</li>
                                                        </a>
                                                        ...
                                                        <a style="display:none;" href="{{ route('flash.deals') }}">
                                                            <li><i data-feather="battery-charging"></i>{{ __('Flash Deals') }}</li>
                                                        </a>
                                                        ...
                                                        @if(Auth::User()->role == "instructor")
                                                        <a style="display:none;" href="{{ route('plan.page') }}">
                                                            <li><i data-feather="tag"></i>{{ __('InstructorPlan') }}</li>
                                                        </a>
                                                        @endif
                                                        @endif
                                                        ...
                                                        @if(Auth::User()->role == "user" || Auth::User()->role == "instructor")
                                                        @if($gsetting->device_control == 1)
                                                        <a style="display:none;" href="{{ route('active.courses') }}" title="Watchlist">
                                                            <li><i data-feather="framer"></i>{{ __('Watchlist') }}</li>
                                                        </a>
                                                        @endif
                                                        @endif
                                                        ...
                                                        @if($gsetting->donation_enable == 1)
                                                        <a style="display:none;" target="__blank" href="{{ $gsetting->donation_link }}" title="Donation">
                                                            <li><i data-feather="framer"></i>{{ __('Donation') }}</li>
                                                        </a>
                                                        @endif
                                                        ...
                                                        @if(isset($wallet_settings) && $wallet_settings->status == 1)
                                                        <a style="display:none;" href="{{ url('/wallet') }}">
                                                            <li><i class="icon-wallet icons"></i>{{ __('MyWallet') }}</li>
                                                        </a>
                                                        @endif

                                                        @if(isset($affiliate) && $affiliate->status == 1)
                                                        <a style="display:none;" href="{{ route('get.affiliate') }}">
                                                            <li><i data-feather="users"></i>{{ __('Affiliate') }}</li>
                                                        </a>
                                                        @endif
                                                        ...
                                                        <a style="display:none;" href="{{ route('compare.index') }}">
                                                            <li><i data-feather="bar-chart"></i>{{ __("Compare") }}</li>
                                                        </a>
                                                        ...
                                                        @endif
                                                        @endif
                                                        <a style="display:none;" href="{{ route('my.leaderboard') }}">
                                                            <li><i class="icon-chart icons"></i>{{ __('MyLeaderboard') }}</li>
                                                        </a>
                                                        @if(Auth::User()->role == "user")
                                                        <a style="display:none;" href="{{ route('studentprofile') }}">
                                                            <li><i data-feather="share"></i>{{ __('Share profile') }}</li>
                                                        </a>
                                                        @endif
                                                        <a style="display:none;" href="{{ route('affilate.report') }}">
                                                            <li><i data-feather="users"></i>{{__('Affiliate Dashboard')}}</li>
                                                        </a>
                                                        <a style="display:none;" href="{{ route('batch.front') }}">
