                        ...
                        <ul>
                            ...
                            @if($gsetting->instructor_enable == 1)
                                @if(Auth::check())
                                    ...
                                    <li><a href="#" data-toggle="modal" title="{{ __('Become An Instructor')}}">{{ __('Become An Instructor') }}</a></li>
                                    @endif
                                @else
                                    <li><a href="#" title="{{ __('Become An Instructor') }}">{{ __('Become An Instructor') }}</a></li>
                                @endif
                            @endif

                            @if(isset($widgets) && $widgets->about_enable == 1)
                            <li><a href="#" title="{{ __('About us') }}">{{ __('About us') }}</a></li>
                            @endif
                            
                            @if(isset($widgets) && $widgets->contact_enable == 1)
                            <li><a href="#" title="{{ __('Contact us') }}">{{ __('Contact us') }}</a></li>
                            @endif
                            @php
                            $menus = App\Menu::get();
                            $pages = App\Page::get();
                ...
                <div class="col-lg-2 col-md-2 col-4">
                    ...
                    <div class="footer-link">
                        <ul>
                            ...
                            <li><a href="#" title="{{ __('Careers') }}">{{ __('Careers') }}</a></li>
                            @endif

                            @if(isset($widgets) && $widgets->blog_enable == 1)
                            <li><a href="#" title="{{ __('Blog') }}">{{ __('Blog') }}</a></li>
                            @endif

                            @if(isset($widgets) && $widgets->help_enable == 1)
                            <li><a href="#" title="{{ __('Help&Support') }}">{{ __('Help&Support') }}</a></li>
                            @endif
                            @php
                            $menus = App\Menu::get();
                            $pages = App\Page::get();
